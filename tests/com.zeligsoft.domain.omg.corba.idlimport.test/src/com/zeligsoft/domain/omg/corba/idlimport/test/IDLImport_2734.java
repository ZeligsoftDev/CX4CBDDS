 ...
 * @author Toby McClean
 * 
 *         Summary: Inheritance in another module with absolute scope lookup
 * 
 *         Action: 1. Import artifact: test29.idl
 * 
 *         Expected Results: 1. Import is successful. Interface E is brought
 *         into the tool inheriting from interface C.
 */
@SuppressWarnings("nls")
public class IDLImport_2734 extends IDLImportTestCase {

	private static final String IDL_FILE = "idl/test29.idl";

	private static final String IDL_FILE_QN = DEAULT_MODEL_NAME + "::" + IMPORTED_PACKAGE_NAME + "::test29";
	...
	private static final String MODULE_D_QN = IDL_FILE_QN + "::D";
	...
	public void test2734() {
		...
		assertModuleMemberCount(moduleA, 1);
