 ...
 * @generated
 */
public class DeploymentPortPartTest extends DeploymentPartTest {
	...
	public static void main(String[] args) {
		TestRunner.run(DeploymentPortPartTest.class);
	}
	 ...
	 * @generated
	 */
	public DeploymentPortPartTest(String name) {
		super(name);
	}
	 ...
	 */
	@Override
	protected DeploymentPortPart getFixture() {
		return (DeploymentPortPart)fixture;
	}
	...
	protected void setUp() throws Exception {
		setFixture(DeploymentFactory.eINSTANCE.createDeploymentPortPart());
	}
