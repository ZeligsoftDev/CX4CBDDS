...
public class ManifestAccess extends TextFileAccess implements IGuiceAwareGeneratorComponent {
  private static final Logger LOG = LogManager.getLogger(ManifestAccess.class);
  ...
  public CharSequence getContent() {
    ...
    _builder.newLine();
    _builder.append("Bundle-Name: �bundleName�");
    _builder.newLine();
    _builder.append("Bundle-SymbolicName: �symbolicName ?: bundleName�;singleton:=true");
    _builder.newLine();
    _builder.append("�IF !version.nullOrEmpty�");
    _builder.newLine();
    _builder.append("\t");
    _builder.append("Bundle-Version: �version�");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("�IF !exportedPackages.empty�");
    _builder.newLine();
    _builder.append("\t");
    _builder.append("Export-Package: �FOR pack : exportedPackages.sort SEPARATOR \',\\n \'��pack��ENDFOR�");
    _builder.newLine();
    _builder.append("�ENDIF�");
    _builder.newLine();
    _builder.append("�IF !requiredBundles.empty�");
    _builder.newLine();
    _builder.append("\t");
    _builder.append("Require-Bundle: �FOR bundle : requiredBundles.sort.filter[it != effectiveSymbolicName] SEPARATOR \',\\n \'��bundle��ENDFOR�");
    _builder.newLine();
    _builder.append("�ENDIF�");
    _builder.newLine();
    _builder.append("�IF !importedPackages.empty�");
    _builder.newLine();
    _builder.append("\t");
    _builder.append("Import-Package: �FOR pack : importedPackages.sort SEPARATOR \',\\n \'��pack��ENDFOR�");
    _builder.newLine();
    _builder.append("�ENDIF�");
    _builder.newLine();
    _builder.append("�IF activator !== null�");
    _builder.newLine();
    _builder.append("\t");
    _builder.append("Bundle-Activator: �activator�");
    _builder.newLine();
    _builder.append("�ENDIF�");
    _builder.newLine();
    _builder.append("Automatic-Module-Name: �symbolicName ?: bundleName�");
    _builder.newLine();
    return _builder;
  }
