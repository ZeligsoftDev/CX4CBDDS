...
public class EMFGeneratorFragment2 extends AbstractXtextGeneratorFragment {
  private static final Logger LOG = LogManager.getLogger(EMFGeneratorFragment2.class);
    ...
    try {
      ...
      if (_not) {
        ...
        if ((!this.skipGenerate)) {
          ...
          _builder.append("Generating EMF model�IF generateEdit��IF generateEditor�, edit�ELSE� and edit�ENDIF��ENDIF��IF generateEditor� and editor�ENDIF� code");
            ...
            for (final EPackage pkg : generatedPackages) {
              {
                ...
                StringConcatenationClient _client = new StringConcatenationClient() {
                  ...
                  protected void appendTo(StringConcatenationClient.TargetStringConcatenation _builder) {
                    _builder.append("�genPkg.packageInterfaceName�.eINSTANCE");
                  }
                };
                ...
                StringConcatenationClient _client_1 = new StringConcatenationClient() {
                  @Override
                  protected void appendTo(StringConcatenationClient.TargetStringConcatenation _builder) {
                    _builder.append("�genPkg.factoryInterfaceName�.eINSTANCE");
                  }
                };
  ...
  protected void addProjectContributions(final Grammar grammar, final List<EPackage> generatedPackages, final ResourceSet rs) {
    ...
    if (_tripleNotEquals) {
      ...
      _builder.newLine();
      _builder.append("\t");
      _builder.append("�FOR pack : generatedPackages�");
      _builder.newLine();
      _builder.append("\t\t");
      _builder.append("<package");
      _builder.newLine();
      _builder.append("\t\t\t");
      _builder.append("uri = \"�pack.nsURI�\"");
      _builder.newLine();
      _builder.append("\t\t\t");
      _builder.append("class = \"�pack.getGenPackage(rs).qualifiedPackageInterfaceName�\"");
      _builder.newLine();
      _builder.append("\t\t\t");
      _builder.append("genModel = \"�grammar.genModelPath.relativePath�\" />");
      _builder.newLine();
      _builder.append("\t");
    ...
    for (final EPackage pack : generatedPackages) {
      {
        final GenPackage genPackage = GenModelUtil2.getGenPackage(pack, rs);
        ...
        StringConcatenationClient _client = new StringConcatenationClient() {
          @Override
          protected void appendTo(StringConcatenationClient.TargetStringConcatenation _builder) {
            _builder.append("if (!�EPackage�.Registry.INSTANCE.containsKey(\"�pack.nsURI�\")) {");
            _builder.newLine();
            _builder.append("\t");
            _builder.append("�EPackage�.Registry.INSTANCE.put(\"�pack.nsURI�\", �new TypeReference(genPackage.qualifiedPackageInterfaceName)�.eINSTANCE);");
            _builder.newLine();
            _builder.append("}");
            _builder.newLine();
          }
