...
public class XtextAntlrGeneratorComparisonFragment extends FragmentAdapter {
  public static class ErrorHandler implements AntlrGrammarComparator.IErrorHandler {
    ...
    public void handleInvalidGeneratedGrammarFile(final AntlrGrammarComparator.ErrorContext context) {
      ...
      _builder.append("Noticed an unexpectect character sequence in reference grammar after token �context.testedGrammar.getPreviousToken�");
      _builder.newLine();
      _builder.append("\t");
      _builder.append("and before token �context.testedGrammar.getCurrentToken� in line �context.testedGrammar.getLineNumber�");
      _builder.newLine();
      _builder.append("\t");
      _builder.append("in file �context.testedGrammar.getAbsoluteFileName�.");
    ...
    public void handleInvalidReferenceGrammarFile(final AntlrGrammarComparator.ErrorContext context) {
      ...
      StringConcatenation _builder = new StringConcatenation();
      _builder.append("Noticed an unexpectect character sequence in reference grammar after token �context.referenceGrammar.getPreviousToken�");
      _builder.newLine();
      _builder.append("\t");
      _builder.append("and before token �context.referenceGrammar.getCurrentToken� in line �context.referenceGrammar.getLineNumber�");
      _builder.newLine();
      _builder.append("\t");
      _builder.append("in file �context.referenceGrammar.getAbsoluteFileName�.");
      throw new RuntimeException(_builder.toString());
    }
    ...
    public void handleMismatch(final String match, final String matchReference, final AntlrGrammarComparator.ErrorContext context) {
      XtextAntlrGeneratorComparisonFragment.copyFile(context.getReferenceGrammar().getAbsoluteFileName(), context.getTestedGrammar().getAbsoluteFileName());
      StringConcatenation _builder = new StringConcatenation();
      _builder.append("Generated grammar �context.testedGrammar.getAbsoluteFileName�");
      _builder.newLine();
      _builder.append("\t");
      _builder.append("differs at token �match� (line �context.testedGrammar.getLineNumber�), expected token �matchReference� (line �");
      _builder.newLine();
      _builder.append("\t\t");
      _builder.append("context.referenceGrammar.getLineNumber�).");
      throw new RuntimeException(_builder.toString());
    }
  }
  ...
  private static final Logger LOG = LogManager.getLogger(XtextAntlrGeneratorComparisonFragment.class);
  ...
  protected RuntimeException loadAndCompareGrammars(final IFileSystemAccess2 fsa, final String outlet, final AntlrGrammarComparator.IErrorHandler errorHandler) {
    try {
      ...
      StringConcatenation _builder = new StringConcatenation();
      _builder.append("�tmpFolder.absolutePath�/�lexerGrammarFileName�");
      final String absoluteLexerGrammarFileNameReference = _builder.toString();
      StringConcatenation _builder_1 = new StringConcatenation();
      _builder_1.append("�tmpFolder.absolutePath�/�parserGrammarFileName�");
      ...
      if (_not) {
        ...
        try {
          ...
          _builder_2.append("�fsa.path�/�lexerGrammarFileName�");
          ...
          _builder_3.append("Generated �type� lexer grammar of �resultLexer.testedGrammar.getLineNumber");
          _builder_3.newLine();
          _builder_3.append("\t\t\t\t\t\t");
          _builder_3.append("� lines matches expected one of �resultLexer.referenceGrammar.getLineNumber�.");
      ...
      try {
        StringConcatenation _builder_2 = new StringConcatenation();
        _builder_2.append("�fsa.path�/�parserGrammarFileName�");
        ...
        StringConcatenation _builder_3 = new StringConcatenation();
        _builder_3.append("Generated �type� parser grammar of �result.testedGrammar.getLineNumber");
        _builder_3.newLine();
        _builder_3.append("\t\t\t\t\t");
        _builder_3.append("� lines matches expected one of �result.referenceGrammar.getLineNumber� (�stopWatch.reset� ms).");
        XtextAntlrGeneratorComparisonFragment.LOG.info(_builder_3);
      } catch (final Throwable _t) {
        if (_t instanceof RuntimeException) {
          final RuntimeException e = (RuntimeException)_t;
  ...
  protected static void copyFile(final String from, final String to) {
    try {
      ...
      StringConcatenation _builder = new StringConcatenation();
      _builder.append("�to.substring(0, to.length - 2)�Expected.g");
