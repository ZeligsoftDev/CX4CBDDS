...
public class CollectionTypeImpl extends BuiltinBaseType implements ParameterizedType {
	private static final Logger LOG = LogManager.getLogger(CollectionTypeImpl.class);
	...
	private Type getInnerTypeRec(final Type type) {
		Type result = type;
	...
	public Feature[] getContributedFeatures() {
		return new Feature[] {
				...
				new OperationImpl(this, "containsAll", getTypeSystem().getBooleanType(), getTypeSystem().getCollectionType(
						getTypeSystem().getObjectType())) {
				...
				new OperationImpl(this, "union", getTypeSystem().getSetType(getInnerType()), getTypeSystem().getCollectionType(
						getTypeSystem().getObjectType())) {
				...
				new OperationImpl(this, "without", getTypeSystem().getSetType(getInnerType()), getTypeSystem().getCollectionType(
						getTypeSystem().getObjectType())) {
				...
				new OperationImpl(this, "intersect", getTypeSystem().getSetType(getInnerType()), getTypeSystem().getCollectionType(
						getTypeSystem().getObjectType())) {
				...
				new OperationImpl(this, "flatten", getTypeSystem().getListType(getInnerTypeRec(CollectionTypeImpl.this)), new Type[0]) {
