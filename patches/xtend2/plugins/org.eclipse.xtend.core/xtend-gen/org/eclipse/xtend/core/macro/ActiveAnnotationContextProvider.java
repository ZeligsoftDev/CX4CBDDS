...
public class ActiveAnnotationContextProvider {
  private static final Logger logger = LogManager.getLogger(ActiveAnnotationContextProvider.class);
        ...
        if (_not) {
          ...
          try {
            ...
            if (_t instanceof VirtualMachineError) {
              ...
              _builder.append("Problem while loading annotation processor: �switch e {");
              _builder.newLine();
              _builder.append("\t\t\t\t\t\t\t");
              _builder.append("ExceptionInInitializerError : e.exception.message");
              _builder.newLine();
              _builder.append("\t\t\t\t\t\t\t");
              _builder.append("default : e.message");
              _builder.newLine();
              _builder.append("\t\t\t\t\t\t");
              _builder.append("}�");
