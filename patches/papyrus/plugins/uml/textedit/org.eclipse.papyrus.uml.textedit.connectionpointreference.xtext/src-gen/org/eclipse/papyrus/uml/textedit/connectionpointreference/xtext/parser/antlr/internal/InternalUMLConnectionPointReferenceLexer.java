...
public class InternalUMLConnectionPointReferenceLexer extends Lexer {
	...
	public final void mRULE_ID() throws RecognitionException {
		try {
			int _type = RULE_ID;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalUMLConnectionPointReference.g:156:9: ( ( ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )* | '\\'' ( options {greedy=false; } : . )* '\\'' ) )
			// InternalUMLConnectionPointReference.g:156:11: ( ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )* | '\\'' ( options {greedy=false; } : . )* '\\'' )
			{
				// InternalUMLConnectionPointReference.g:156:11: ( ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )* | '\\'' ( options {greedy=false; } : . )* '\\'' )
				int alt3 = 2;
				...
				switch (alt3) {
				case 1:
				// InternalUMLConnectionPointReference.g:156:12: ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
				{
					...
					// InternalUMLConnectionPointReference.g:156:36: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
					loop1: do {
						int alt1 = 2;
					...
					break;
				case 2:
				// InternalUMLConnectionPointReference.g:156:70: '\\'' ( options {greedy=false; } : . )* '\\''
				{
					match('\'');
					// InternalUMLConnectionPointReference.g:156:75: ( options {greedy=false; } : . )*
					loop2: do {
						int alt2 = 2;
						...
						switch (alt2) {
						case 1:
						// InternalUMLConnectionPointReference.g:156:103: .
						{
							matchAny();
	...
	public final void mRULE_STRING() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalUMLConnectionPointReference.g:158:13: ( '\"' ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\"' | '\\'' | '\\\\' ) | ~ ( ( '\\\\' | '\"' ) ) )* '\"' )
			// InternalUMLConnectionPointReference.g:158:15: '\"' ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\"' | '\\'' | '\\\\' ) | ~ ( ( '\\\\' | '\"' ) ) )* '\"'
			{
				match('\"');
				// InternalUMLConnectionPointReference.g:158:19: ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\"' | '\\'' | '\\\\' ) | ~ ( ( '\\\\' | '\"' ) ) )*
				loop4: do {
					int alt4 = 3;
					...
					switch (alt4) {
					case 1:
					// InternalUMLConnectionPointReference.g:158:20: '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\"' | '\\'' | '\\\\' )
					{
						match('\\');
						...
						break;
					case 2:
					// InternalUMLConnectionPointReference.g:158:61: ~ ( ( '\\\\' | '\"' ) )
					{
	...
	public final void mRULE_ML_COMMENT() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalUMLConnectionPointReference.g:160:17: ( '/*' ~ ( '@' ) ( options {greedy=false; } : . )* '*/' )
			// InternalUMLConnectionPointReference.g:160:19: '/*' ~ ( '@' ) ( options {greedy=false; } : . )* '*/'
			{
				match("/*");
				...
				// InternalUMLConnectionPointReference.g:160:31: ( options {greedy=false; } : . )*
				loop5: do {
					int alt5 = 2;
					...
					switch (alt5) {
					case 1:
					// InternalUMLConnectionPointReference.g:160:59: .
					{
						matchAny();
	...
	public final void mRULE_SL_COMMENT() throws RecognitionException {
		try {
			...
			// InternalUMLConnectionPointReference.g:162:19: '//' (~ ( ( '\\n' | '\\r' | '@' ) ) )* ( ( '\\r' )? '\\n' )?
			{
				...
				// InternalUMLConnectionPointReference.g:162:24: (~ ( ( '\\n' | '\\r' | '@' ) ) )*
				loop6: do {
					int alt6 = 2;
				...
				// InternalUMLConnectionPointReference.g:162:44: ( ( '\\r' )? '\\n' )?
				int alt8 = 2;
	...
	public final void mRULE_INT() throws RecognitionException {
		try {
			int _type = RULE_INT;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalUMLConnectionPointReference.g:164:10: ( ( '0' .. '9' )+ )
			// InternalUMLConnectionPointReference.g:164:12: ( '0' .. '9' )+
			{
				// InternalUMLConnectionPointReference.g:164:12: ( '0' .. '9' )+
				int cnt9 = 0;
				loop9: do {
					...
					switch (alt9) {
					case 1:
					// InternalUMLConnectionPointReference.g:164:13: '0' .. '9'
					{
						matchRange('0', '9');
	...
	public final void mRULE_INTEGER_VALUE() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalUMLConnectionPointReference.g:166:20: ( ( ( '0' | '1' .. '9' ( ( '_' )? '0' .. '9' )* ) | ( '0b' | '0B' ) '0' .. '1' ( ( '_' )? '0' .. '1' )* | ( '0x' | '0X' ) ( '0' .. '9' | 'a' .. 'f' | 'A' .. 'F' ) ( ( '_' )? ( '0' .. '9' | 'a' .. 'f'
			// | 'A' .. 'F' ) )* | '0' ( '_' )? '0' .. '7' ( ( '_' )? '0' .. '7' )* ) )
			// InternalUMLConnectionPointReference.g:166:22: ( ( '0' | '1' .. '9' ( ( '_' )? '0' .. '9' )* ) | ( '0b' | '0B' ) '0' .. '1' ( ( '_' )? '0' .. '1' )* | ( '0x' | '0X' ) ( '0' .. '9' | 'a' .. 'f' | 'A' .. 'F' ) ( ( '_' )? ( '0' .. '9' | 'a' .. 'f' |
			// 'A' .. 'F' ) )* | '0' ( '_' )? '0' .. '7' ( ( '_' )? '0' .. '7' )* )
			{
				// InternalUMLConnectionPointReference.g:166:22: ( ( '0' | '1' .. '9' ( ( '_' )? '0' .. '9' )* ) | ( '0b' | '0B' ) '0' .. '1' ( ( '_' )? '0' .. '1' )* | ( '0x' | '0X' ) ( '0' .. '9' | 'a' .. 'f' | 'A' .. 'F' ) ( ( '_' )? ( '0' .. '9' | 'a' ..
				// 'f' | 'A' .. 'F' ) )* | '0' ( '_' )? '0' .. '7' ( ( '_' )? '0' .. '7' )* )
				int alt22 = 4;
				...
				switch (alt22) {
				case 1:
				// InternalUMLConnectionPointReference.g:166:23: ( '0' | '1' .. '9' ( ( '_' )? '0' .. '9' )* )
				{
					// InternalUMLConnectionPointReference.g:166:23: ( '0' | '1' .. '9' ( ( '_' )? '0' .. '9' )* )
					int alt12 = 2;
					...
					switch (alt12) {
					case 1:
					// InternalUMLConnectionPointReference.g:166:24: '0'
					{
						match('0');
						...
						break;
					case 2:
					// InternalUMLConnectionPointReference.g:166:28: '1' .. '9' ( ( '_' )? '0' .. '9' )*
					{
						matchRange('1', '9');
						// InternalUMLConnectionPointReference.g:166:37: ( ( '_' )? '0' .. '9' )*
						loop11: do {
							int alt11 = 2;
							...
							switch (alt11) {
							case 1:
							// InternalUMLConnectionPointReference.g:166:38: ( '_' )? '0' .. '9'
							{
								// InternalUMLConnectionPointReference.g:166:38: ( '_' )?
								int alt10 = 2;
					...
					break;
				case 2:
				// InternalUMLConnectionPointReference.g:166:55: ( '0b' | '0B' ) '0' .. '1' ( ( '_' )? '0' .. '1' )*
				{
					// InternalUMLConnectionPointReference.g:166:55: ( '0b' | '0B' )
					int alt13 = 2;
					...
					switch (alt13) {
					case 1:
					// InternalUMLConnectionPointReference.g:166:56: '0b'
					{
						match("0b");
						...
						break;
					case 2:
					// InternalUMLConnectionPointReference.g:166:61: '0B'
					{
						match("0B");
					...
					matchRange('0', '1');
					// InternalUMLConnectionPointReference.g:166:76: ( ( '_' )? '0' .. '1' )*
					loop15: do {
						int alt15 = 2;
						...
						switch (alt15) {
						case 1:
						// InternalUMLConnectionPointReference.g:166:77: ( '_' )? '0' .. '1'
						{
							// InternalUMLConnectionPointReference.g:166:77: ( '_' )?
							int alt14 = 2;
					...
					break;
				case 3:
				// InternalUMLConnectionPointReference.g:166:93: ( '0x' | '0X' ) ( '0' .. '9' | 'a' .. 'f' | 'A' .. 'F' ) ( ( '_' )? ( '0' .. '9' | 'a' .. 'f' | 'A' .. 'F' ) )*
				{
					// InternalUMLConnectionPointReference.g:166:93: ( '0x' | '0X' )
					int alt16 = 2;
					...
					switch (alt16) {
					case 1:
					// InternalUMLConnectionPointReference.g:166:94: '0x'
					{
						match("0x");
						...
						break;
					case 2:
					// InternalUMLConnectionPointReference.g:166:99: '0X'
					{
						match("0X");
					...
					// InternalUMLConnectionPointReference.g:166:134: ( ( '_' )? ( '0' .. '9' | 'a' .. 'f' | 'A' .. 'F' ) )*
					loop18: do {
						int alt18 = 2;
						...
						switch (alt18) {
						case 1:
						// InternalUMLConnectionPointReference.g:166:135: ( '_' )? ( '0' .. '9' | 'a' .. 'f' | 'A' .. 'F' )
						{
							// InternalUMLConnectionPointReference.g:166:135: ( '_' )?
							int alt17 = 2;
					...
					break;
				case 4:
				// InternalUMLConnectionPointReference.g:166:171: '0' ( '_' )? '0' .. '7' ( ( '_' )? '0' .. '7' )*
				{
					match('0');
					// InternalUMLConnectionPointReference.g:166:175: ( '_' )?
					int alt19 = 2;
					...
					matchRange('0', '7');
					// InternalUMLConnectionPointReference.g:166:189: ( ( '_' )? '0' .. '7' )*
					loop21: do {
						int alt21 = 2;
						...
						switch (alt21) {
						case 1:
						// InternalUMLConnectionPointReference.g:166:190: ( '_' )? '0' .. '7'
						{
							// InternalUMLConnectionPointReference.g:166:190: ( '_' )?
							int alt20 = 2;
	...
	public final void mRULE_ANY_OTHER() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalUMLConnectionPointReference.g:170:16: ( . )
			// InternalUMLConnectionPointReference.g:170:18: .
			{
				matchAny();
