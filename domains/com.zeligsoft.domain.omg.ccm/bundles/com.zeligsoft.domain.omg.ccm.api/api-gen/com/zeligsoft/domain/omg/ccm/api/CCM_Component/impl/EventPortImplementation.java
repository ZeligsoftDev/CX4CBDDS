...
public class EventPortImplementation
    extends PortImplementation implements EventPort{
    ...
    public Type getType(){
        if(_type == null) {
            final Object rawValue = 
                com.zeligsoft.base.zdl.util.ZDLUtil.getValue(eObject(), "CCM::CCM_Component::EventPort", "type");
    ...
    public java.util.List<Event> getPublishesEvent(){
        if(_publishesEvent == null) {
            final Object rawValue = 
                com.zeligsoft.base.zdl.util.ZDLUtil.getValue(eObject(), "CCM::CCM_Component::EventPort", "publishesEvent");
            ...
            for(Object next : rawList) {
                if(next instanceof org.eclipse.emf.ecore.EObject) {
                    Event nextWrapper = 
                         ZDLFactoryRegistry.INSTANCE.create((org.eclipse.emf.ecore.EObject) next, Event.class);
    ...
    public java.util.List<Event> getConsumesEvent(){
        if(_consumesEvent == null) {
            final Object rawValue = 
                com.zeligsoft.base.zdl.util.ZDLUtil.getValue(eObject(), "CCM::CCM_Component::EventPort", "consumesEvent");
