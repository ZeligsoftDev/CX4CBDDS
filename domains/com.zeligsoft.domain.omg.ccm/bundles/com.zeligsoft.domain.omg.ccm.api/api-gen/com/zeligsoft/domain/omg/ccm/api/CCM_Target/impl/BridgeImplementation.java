...
public class BridgeImplementation
    extends NamedElementImplementation implements Bridge{
    ...
    public java.util.List<ResourceProperty> getResource(){
        if(_resource == null) {
            final Object rawValue = 
                com.zeligsoft.base.zdl.util.ZDLUtil.getValue(eObject(), "CCM::CCM_Target::Bridge", "resource");
    ...
    public <T extends ResourceProperty> T addResource(Class<T> typeToCreate, String concept){
    	...
    	org.eclipse.emf.ecore.EObject newConcept = 
    		ZDLUtil.createZDLConcept(element, "CCM::CCM_Target::Bridge", "resource", concept);
    ...
    public ResourceProperty addResource(){
    	...
    	getResource();
    	org.eclipse.emf.ecore.EObject newConcept = 
    		ZDLUtil.createZDLConcept(element, "CCM::CCM_Target::Bridge", "resource", "CCM::CCM_Target::ResourceProperty");
