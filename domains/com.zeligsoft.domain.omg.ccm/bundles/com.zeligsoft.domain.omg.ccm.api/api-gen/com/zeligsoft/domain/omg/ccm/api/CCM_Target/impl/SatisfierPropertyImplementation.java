...
public class SatisfierPropertyImplementation
    extends NamedElementImplementation implements SatisfierProperty{
    ...
    public Boolean getDynamic(){
            final Object rawValue =
                com.zeligsoft.base.zdl.util.ZDLUtil.getValue(eObject(), "CCM::CCM_Target::SatisfierProperty", "dynamic");
            return (Boolean) rawValue;
    }
    public void setDynamic(Boolean val)
    {
    				ZDLUtil.setValue(element, "CCM::CCM_Target::SatisfierProperty", "dynamic", val);
    			}
    public String getValue(){
            final Object rawValue =
                com.zeligsoft.base.zdl.util.ZDLUtil.getValue(eObject(), "CCM::CCM_Target::SatisfierProperty", "value");
            return (String) rawValue;
    }
    public void setValue(String val)
    {
    				ZDLUtil.setValue(element, "CCM::CCM_Target::SatisfierProperty", "value", val);
    			}
    ...
    public CORBAType getTypeOverride(){
        if(_type == null) {
            final Object rawValue = 
                com.zeligsoft.base.zdl.util.ZDLUtil.getValue(eObject(), "CCM::CCM_Target::SatisfierProperty", "type");
    ...
    {
    				ZDLUtil.setValue(element, "CCM::CCM_Target::SatisfierProperty", "type", val.eObject());
    			}
    public Type getType(){
    ...
    public SatisfierPropertyKind getKind(){
            final Object rawValue =
                com.zeligsoft.base.zdl.util.ZDLUtil.getValue(eObject(), "CCM::CCM_Target::SatisfierProperty", "kind");
            
            if(_kind == null) {
            if(rawValue instanceof org.eclipse.emf.ecore.EObject) {
                _kind = SatisfierPropertyKind.create((org.eclipse.emf.ecore.EObject) rawValue);
            }
            }
            return _kind;
    }
    ...
    {
    				ZDLUtil.setValue(element, "CCM::CCM_Target::SatisfierProperty", "kind", val.eObject(element));
    			}
