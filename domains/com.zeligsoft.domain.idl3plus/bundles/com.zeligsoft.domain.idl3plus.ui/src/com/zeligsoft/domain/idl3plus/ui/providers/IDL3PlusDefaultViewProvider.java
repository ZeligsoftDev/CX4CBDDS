...
import com.zeligsoft.domain.idl3plus.ui.viewcustomizers.IDL3PlusConnectorViewCustomizer;
import com.zeligsoft.domain.idl3plus.ui.viewcustomizers.IDL3PlusPropertyViewCustomizer;
 ...
 * 
 */
public class IDL3PlusDefaultViewProvider
	...
	static {
		nodeMap.put(UMLPackage.eINSTANCE.getComponent(),
			IDL3PlusConnectorViewCustomizer.INSTANCE);
		nodeMap.put(UMLPackage.eINSTANCE.getProperty(),
			IDL3PlusPropertyViewCustomizer.INSTANCE);
	}
