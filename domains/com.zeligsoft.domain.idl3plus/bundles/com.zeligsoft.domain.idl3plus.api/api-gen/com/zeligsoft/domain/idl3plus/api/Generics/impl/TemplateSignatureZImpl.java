...
public class TemplateSignatureZImpl
    extends ZObjectImpl implements TemplateSignature{
    ...
    public java.util.List<TypeParameter> getTypeParameter(){
        if(_typeParameter == null) {
            final Object rawValue = 
                com.zeligsoft.base.zdl.util.ZDLUtil.getValue(eObject(), "IDL3Plus::Generics::TemplateSignature", "typeParameter");
            _typeParameter = new java.util.ArrayList<TypeParameter>();
            @SuppressWarnings("unchecked")
            final java.util.List<Object> rawList = (java.util.List<Object>) rawValue;
            for(Object next : rawList) {
                if(next instanceof org.eclipse.emf.ecore.EObject) {
                    TypeParameter nextWrapper = 
                         ZDLFactoryRegistry.INSTANCE.create((org.eclipse.emf.ecore.EObject) next, TypeParameter.class);
    ...
    public <T extends TypeParameter> T addTypeParameter(Class<T> typeToCreate, String concept){
    	...
    	org.eclipse.emf.ecore.EObject newConcept = 
    		ZDLUtil.createZDLConcept(element, "IDL3Plus::Generics::TemplateSignature", "typeParameter", concept);
    ...
    public TypeParameter addTypeParameter(){
    	...
    	getTypeParameter();
    	org.eclipse.emf.ecore.EObject newConcept = 
    		ZDLUtil.createZDLConcept(element, "IDL3Plus::Generics::TemplateSignature", "typeParameter", "IDL3Plus::Generics::TypeParameter");
