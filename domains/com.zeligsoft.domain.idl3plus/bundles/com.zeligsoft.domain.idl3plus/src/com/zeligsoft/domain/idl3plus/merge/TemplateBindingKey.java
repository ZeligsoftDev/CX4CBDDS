 ...
 *
 */
public class TemplateBindingKey
	extends AbstractHierarchicalKey<TemplateBindingKey>{
	 ...
	 * @param element
	 */
	public TemplateBindingKey(TemplateBinding element) {
		super(element);
		
		NamedElement nearestNamedElement = getNearestNamedElement(element);
		
		if(nearestNamedElement == null) {
			throw new IllegalArgumentException(Messages.TemplateBindingKey_Exception_ElementMustHaveAncestor);
		}
	 ...
	 */
	@Override
	protected boolean keyEquals(TemplateBindingKey other) {
