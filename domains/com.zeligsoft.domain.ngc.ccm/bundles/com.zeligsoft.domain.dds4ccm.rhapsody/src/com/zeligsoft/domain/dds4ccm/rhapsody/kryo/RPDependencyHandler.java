...
class RPDependencyHandler extends AbstractKryoHandler {
	...
	private void setGetDependsOn(Object value) {
		this.getterValues.put("getDependsOn", value);
	}

	public void read(Kryo kryo, Input input) {
	
		this.getterValues.put("getMetaClass", "Dependency");
		setGetDependsOn(kryo.readClassAndObject(input));
