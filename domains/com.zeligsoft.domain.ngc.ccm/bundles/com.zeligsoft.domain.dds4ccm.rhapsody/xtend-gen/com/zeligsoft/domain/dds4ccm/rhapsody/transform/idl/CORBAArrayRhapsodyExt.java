...
public class CORBAArrayRhapsodyExt {
  @Inject
  ...
  protected CORBAArray _importCorbaArray(final IRPType source, final Object context) {
    final String name = source.getName();
    boolean _isZDLConcept = this._rhapsodyZDLUtil.isZDLConcept(source, CORBADomainNames.CORBAARRAY);
    if (_isZDLConcept) {
      ZObject _createZDLElement = this._dDS4CCMFactory.createZDLElement(context, name, CORBADomainNames.CORBAARRAY, CORBAArray.class);
      final CORBAArray element = ((CORBAArray) _createZDLElement);
  ...
  protected CORBAArray _importCorbaArray(final IRPModelElement source, final Object context) {
    return null;
  }
  
  public CORBAArray importCorbaArray(final IRPModelElement source, final Object context) {
    if (source instanceof IRPType) {
      return _importCorbaArray((IRPType)source, context);
    } else if (source != null) {
      return _importCorbaArray(source, context);
    } else {
