...
if [ "$INPUT" = "R" ] || [ "$INPUT" = "r" ]
then
      echo "Restarting BasicPublisher deployment..."
      
      $SNA_ROOT/tools/scripts/sna_restart_local_deployment.py \
         BasicPublisher_compNode.ior \
         ../descriptors/BasicPublisher_compNodeBasicPubSub_asm.cdp.cdr
         
      echo "Restarting BasicSubscriber deployment..."
...
echo "***                                                 ***"
echo "***         PRESS R TO RESTART COMPONENTS           ***"
echo "*******************************************************"
