...
public class CORBAValueImplementation
    extends CORBATypeImplementation implements CORBAValue{
    ...
    public Boolean getIsAbstract(){
            final Object rawValue =
                com.zeligsoft.base.zdl.util.ZDLUtil.getValue(eObject(), "CORBADomain::IDL::CORBAValue", "isAbstract");
            return (Boolean) rawValue;
    }
    public void setIsAbstract(Boolean val)
    {
    				ZDLUtil.setValue(element, "CORBADomain::IDL::CORBAValue", "isAbstract", val);
    			}
    ...
    public Boolean getIsTruncatable(){
            final Object rawValue =
                com.zeligsoft.base.zdl.util.ZDLUtil.getValue(eObject(), "CORBADomain::IDL::CORBAValue", "isTruncatable");
            return (Boolean) rawValue;
    }
    public void setIsTruncatable(Boolean val)
    {
    				ZDLUtil.setValue(element, "CORBADomain::IDL::CORBAValue", "isTruncatable", val);
    			}
    public Boolean getIsCustom(){
            final Object rawValue =
                com.zeligsoft.base.zdl.util.ZDLUtil.getValue(eObject(), "CORBADomain::IDL::CORBAValue", "isCustom");
            return (Boolean) rawValue;
    }
    public void setIsCustom(Boolean val)
    {
    				ZDLUtil.setValue(element, "CORBADomain::IDL::CORBAValue", "isCustom", val);
    			}
