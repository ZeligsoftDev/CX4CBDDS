...
public class CORBAFieldImplementation
    extends CORBANamedElementImplementation implements CORBAField{
    ...
    public java.util.List<CORBABound> getBounds(){
        if(_bounds == null) {
            final Object rawValue = 
                com.zeligsoft.base.zdl.util.ZDLUtil.getValue(eObject(), "CORBADomain::IDL::CORBAField", "bounds");
            _bounds = new java.util.ArrayList<CORBABound>();
            @SuppressWarnings("unchecked")
            final java.util.List<Object> rawList = (java.util.List<Object>) rawValue;
            for(Object next : rawList) {
                if(next instanceof org.eclipse.emf.ecore.EObject) {
                    CORBABound nextWrapper = 
                         ZDLFactoryRegistry.INSTANCE.create((org.eclipse.emf.ecore.EObject) next, CORBABound.class);
    ...
    public void addBounds(CORBABound val){
    	...
    	final Object rawValue = ZDLUtil.getValue(element, "CORBADomain::IDL::CORBAField", "bounds");
    	@SuppressWarnings("unchecked")
    	final java.util.List<Object> rawList = (java.util.List<Object>) rawValue;
    ...
    public <T extends CORBABound> T addBounds(Class<T> typeToCreate, String concept){
    	// make sure the bounds list is created
    	getBounds();
    	org.eclipse.emf.ecore.EObject newConcept = 
    		ZDLUtil.createZDLConcept(element, "CORBADomain::IDL::CORBAField", "bounds", concept);
    ...
    public CORBABound addBounds(){
    	...
    	getBounds();
    	org.eclipse.emf.ecore.EObject newConcept = 
    		ZDLUtil.createZDLConcept(element, "CORBADomain::IDL::CORBAField", "bounds", "CORBADomain::IDL::CORBABound");
    ...
    public String getBound(){
            final Object rawValue =
                com.zeligsoft.base.zdl.util.ZDLUtil.getValue(eObject(), "CORBADomain::IDL::CORBAField", "bound");
