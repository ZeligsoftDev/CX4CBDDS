...
public class CORBAArrayImplementation
    extends CORBATemplateImplementation implements CORBAArray{
    ...
    public java.util.List<CORBABound> getBounds(){
        if(_bounds == null) {
            final Object rawValue = 
                com.zeligsoft.base.zdl.util.ZDLUtil.getValue(eObject(), "CORBADomain::IDL::CORBAArray", "bounds");
    ...
    public void addBounds(CORBABound val){
    	...
    	final Object rawValue = ZDLUtil.getValue(element, "CORBADomain::IDL::CORBAArray", "bounds");
    	@SuppressWarnings("unchecked")
    	final java.util.List<Object> rawList = (java.util.List<Object>) rawValue;
    ...
    public <T extends CORBABound> T addBounds(Class<T> typeToCreate, String concept){
    	...
    	org.eclipse.emf.ecore.EObject newConcept = 
    		ZDLUtil.createZDLConcept(element, "CORBADomain::IDL::CORBAArray", "bounds", concept);
    ...
    public CORBABound addBounds(){
    	...
    	getBounds();
    	org.eclipse.emf.ecore.EObject newConcept = 
    		ZDLUtil.createZDLConcept(element, "CORBADomain::IDL::CORBAArray", "bounds", "CORBADomain::IDL::CORBABound");
    ...
    public String getIndex(){
            final Object rawValue =
                com.zeligsoft.base.zdl.util.ZDLUtil.getValue(eObject(), "CORBADomain::IDL::CORBAArray", "index");
