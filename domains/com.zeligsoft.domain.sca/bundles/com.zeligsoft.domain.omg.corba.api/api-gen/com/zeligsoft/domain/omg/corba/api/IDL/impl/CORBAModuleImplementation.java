...
public class CORBAModuleImplementation
    extends CORBANamedElementImplementation implements CORBAModule{
    ...
    public java.util.List<CORBAModuleContained> getContents(){
        if(_contents == null) {
            final Object rawValue = 
                com.zeligsoft.base.zdl.util.ZDLUtil.getValue(eObject(), "CORBADomain::IDL::CORBAModule", "contents");
    ...
    public void addContents(CORBAModuleContained val){
    	...
    	final Object rawValue = ZDLUtil.getValue(element, "CORBADomain::IDL::CORBAModule", "contents");
    	@SuppressWarnings("unchecked")
    	final java.util.List<Object> rawList = (java.util.List<Object>) rawValue;
    ...
    public <T extends CORBAModuleContained> T addContents(Class<T> typeToCreate, String concept){
    	// make sure the contents list is created
    	getContents();
    	org.eclipse.emf.ecore.EObject newConcept = 
    		ZDLUtil.createZDLConcept(element, "CORBADomain::IDL::CORBAModule", "contents", concept);
