...
<T extends CORBAOperation> T addOwnedOperation(Class<T> typeToCreate, String concept);
...
<T extends CORBAConstant> T addOwnedConstants(Class<T> typeToCreate, String concept);
...
<T extends CORBAClassifierContained> T addContents(Class<T> typeToCreate, String concept);
/**
 * A predicate which returns true if the Object is an
 * instance of CORBAClassifier
 */
static final TypeSelectPredicate<CORBAClassifier> type = 
    new TypeSelectPredicate<CORBAClassifier>(
