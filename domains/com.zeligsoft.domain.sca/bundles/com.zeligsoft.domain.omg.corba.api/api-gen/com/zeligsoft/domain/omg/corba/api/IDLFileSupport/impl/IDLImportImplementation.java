...
public class IDLImportImplementation
    extends ZObjectImpl implements IDLImport{
    ...
    public IDLFile getTarget(){
        if(_target == null) {
            final Object rawValue = 
                com.zeligsoft.base.zdl.util.ZDLUtil.getValue(eObject(), "CORBADomain::IDLFileSupport::IDLImport", "target");
    ...
    {
    				ZDLUtil.setValue(element, "CORBADomain::IDLFileSupport::IDLImport", "target", val.eObject());
    			}
