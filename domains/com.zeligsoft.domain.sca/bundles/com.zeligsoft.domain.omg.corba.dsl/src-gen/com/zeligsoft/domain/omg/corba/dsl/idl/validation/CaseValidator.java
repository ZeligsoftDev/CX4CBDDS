...
/**
 * A sample validator interface for {@link com.zeligsoft.domain.omg.corba.dsl.idl.Case}.
...
public interface CaseValidator {
	...
	boolean validateLabel(EList<CaseLabel> value);
	boolean validateSpec(ElementSpec value);
}
