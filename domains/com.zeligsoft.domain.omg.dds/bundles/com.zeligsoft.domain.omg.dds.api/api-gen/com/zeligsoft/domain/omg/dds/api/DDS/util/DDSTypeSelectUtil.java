...
public class DDSTypeSelectUtil {
	public List<Specification> selectSpecification(
		...
		final Collection<PackageableElement> elements = Collections2.filter(pkg
				...
				"DDS::Core::Specification"));
		final Collection<Specification> result = Collections2.transform(
				elements, CreateZDLWrapper.create(Specification.class));
		return new ImmutableList.Builder<Specification>().addAll(result)
				.build();
	...
	public List<DDSEntity> selectDDSEntity(org.eclipse.uml2.uml.Package pkg) {
		final Collection<PackageableElement> elements = Collections2.filter(pkg
				.getPackagedElements(), new IsZDLConcept(
				"DDS::Domain::DDSEntity"));
		final Collection<DDSEntity> result = Collections2.transform(elements,
				CreateZDLWrapper.create(DDSEntity.class));
	...
	public List<Topic> selectTopic(org.eclipse.uml2.uml.Package pkg) {
		final Collection<PackageableElement> elements = Collections2.filter(pkg
				.getPackagedElements(), new IsZDLConcept("DDS::Topics::Topic"));
		final Collection<Topic> result = Collections2.transform(elements,
				CreateZDLWrapper.create(Topic.class));
	...
	public List<Publisher> selectPublisher(org.eclipse.uml2.uml.Package pkg) {
		...
		final Collection<Publisher> result = Collections2.transform(elements,
				CreateZDLWrapper.create(Publisher.class));
		return new ImmutableList.Builder<Publisher>().addAll(result).build();

	}

	public List<DDSComponent> selectDDSComponent(
			org.eclipse.uml2.uml.Package pkg) {
		final Collection<PackageableElement> elements = Collections2.filter(pkg
				.getPackagedElements(), new IsZDLConcept(
				"DDS::DCPS::DDSComponent"));
		final Collection<DDSComponent> result = Collections2.transform(
				elements, CreateZDLWrapper.create(DDSComponent.class));
	...
	public List<Domain> selectDomain(org.eclipse.uml2.uml.Package pkg) {
		final Collection<PackageableElement> elements = Collections2.filter(
	...
	public List<PublisherSubscriber> selectPublisherSubscriber(
			org.eclipse.uml2.uml.Package pkg) {
		final Collection<PackageableElement> elements = Collections2.filter(pkg
				.getPackagedElements(), new IsZDLConcept(
				"DDS::DCPS::PublisherSubscriber"));
		final Collection<PublisherSubscriber> result = Collections2.transform(
				elements, CreateZDLWrapper.create(PublisherSubscriber.class));
		return new ImmutableList.Builder<PublisherSubscriber>().addAll(result)
				.build();

	}

	public List<qosPolicy> selectQosPolicy(org.eclipse.uml2.uml.Package pkg) {
		final Collection<PackageableElement> elements = Collections2
				.filter(pkg.getPackagedElements(), new IsZDLConcept(
						"DDS::QOS::qosPolicy"));
		final Collection<qosPolicy> result = Collections2.transform(elements,
				CreateZDLWrapper.create(qosPolicy.class));
		return new ImmutableList.Builder<qosPolicy>().addAll(result).build();

	}

	public List<historyQosPolicy> selectHistoryQosPolicy(
			org.eclipse.uml2.uml.Package pkg) {
		final Collection<PackageableElement> elements = Collections2.filter(pkg
				.getPackagedElements(), new IsZDLConcept(
				"DDS::QOS::historyQosPolicy"));
		final Collection<historyQosPolicy> result = Collections2.transform(
				elements, CreateZDLWrapper.create(historyQosPolicy.class));
		return new ImmutableList.Builder<historyQosPolicy>().addAll(result)
				.build();

	}

	public List<lifespanQosPolicy> selectLifespanQosPolicy(
			org.eclipse.uml2.uml.Package pkg) {
		final Collection<PackageableElement> elements = Collections2.filter(pkg
				.getPackagedElements(), new IsZDLConcept(
				"DDS::QOS::lifespanQosPolicy"));
		final Collection<lifespanQosPolicy> result = Collections2.transform(
				elements, CreateZDLWrapper.create(lifespanQosPolicy.class));
		return new ImmutableList.Builder<lifespanQosPolicy>().addAll(result)
				.build();

	}

	public List<ownershipQosPolicy> selectOwnershipQosPolicy(
			org.eclipse.uml2.uml.Package pkg) {
		final Collection<PackageableElement> elements = Collections2.filter(pkg
				.getPackagedElements(), new IsZDLConcept(
				"DDS::QOS::ownershipQosPolicy"));
		final Collection<ownershipQosPolicy> result = Collections2.transform(
				elements, CreateZDLWrapper.create(ownershipQosPolicy.class));
		return new ImmutableList.Builder<ownershipQosPolicy>().addAll(result)
				.build();
	...
	public List<wdlQosPolicy> selectWdlQosPolicy(
			org.eclipse.uml2.uml.Package pkg) {
		final Collection<PackageableElement> elements = Collections2.filter(pkg
				.getPackagedElements(), new IsZDLConcept(
				"DDS::QOS::wdlQosPolicy"));
		final Collection<wdlQosPolicy> result = Collections2.transform(
				elements, CreateZDLWrapper.create(wdlQosPolicy.class));
		return new ImmutableList.Builder<wdlQosPolicy>().addAll(result).build();

	}

	public List<rdlQosPolicy> selectRdlQosPolicy(
			org.eclipse.uml2.uml.Package pkg) {
		final Collection<PackageableElement> elements = Collections2.filter(pkg
				.getPackagedElements(), new IsZDLConcept(
				"DDS::QOS::rdlQosPolicy"));
		final Collection<rdlQosPolicy> result = Collections2.transform(
				elements, CreateZDLWrapper.create(rdlQosPolicy.class));
	...
	public List<deadlineQosPolicy> selectDeadlineQosPolicy(
			org.eclipse.uml2.uml.Package pkg) {
		final Collection<PackageableElement> elements = Collections2.filter(pkg
				.getPackagedElements(), new IsZDLConcept(
				"DDS::QOS::deadlineQosPolicy"));
		final Collection<deadlineQosPolicy> result = Collections2.transform(
				elements, CreateZDLWrapper.create(deadlineQosPolicy.class));
		return new ImmutableList.Builder<deadlineQosPolicy>().addAll(result)
				.build();
	...
	public List<tbfQosPolicy> selectTbfQosPolicy(
			org.eclipse.uml2.uml.Package pkg) {
		final Collection<PackageableElement> elements = Collections2.filter(pkg
				.getPackagedElements(), new IsZDLConcept(
				"DDS::QOS::tbfQosPolicy"));
		final Collection<tbfQosPolicy> result = Collections2.transform(
				elements, CreateZDLWrapper.create(tbfQosPolicy.class));
	...
	public List<presentationQosPolicy> selectPresentationQosPolicy(
			org.eclipse.uml2.uml.Package pkg) {
		final Collection<PackageableElement> elements = Collections2.filter(pkg
				.getPackagedElements(), new IsZDLConcept(
				"DDS::QOS::presentationQosPolicy"));
		final Collection<presentationQosPolicy> result = Collections2
				.transform(elements,
						CreateZDLWrapper.create(presentationQosPolicy.class));
		return new ImmutableList.Builder<presentationQosPolicy>()
				.addAll(result).build();

	}

	public List<partitionQosPolicy> selectPartitionQosPolicy(
			org.eclipse.uml2.uml.Package pkg) {
		final Collection<PackageableElement> elements = Collections2.filter(pkg
				.getPackagedElements(), new IsZDLConcept(
				"DDS::QOS::partitionQosPolicy"));
		final Collection<partitionQosPolicy> result = Collections2.transform(
				elements, CreateZDLWrapper.create(partitionQosPolicy.class));
		return new ImmutableList.Builder<partitionQosPolicy>().addAll(result)
				.build();

	}

	public List<reliabilityQosPolicy> selectReliabilityQosPolicy(
			org.eclipse.uml2.uml.Package pkg) {
		final Collection<PackageableElement> elements = Collections2.filter(pkg
				.getPackagedElements(), new IsZDLConcept(
				"DDS::QOS::reliabilityQosPolicy"));
		final Collection<reliabilityQosPolicy> result = Collections2.transform(
				elements, CreateZDLWrapper.create(reliabilityQosPolicy.class));
		return new ImmutableList.Builder<reliabilityQosPolicy>().addAll(result)
				.build();
	...
	public List<livelinessQosPolicy> selectLivelinessQosPolicy(
			org.eclipse.uml2.uml.Package pkg) {
		final Collection<PackageableElement> elements = Collections2.filter(pkg
				.getPackagedElements(), new IsZDLConcept(
				"DDS::QOS::livelinessQosPolicy"));
		final Collection<livelinessQosPolicy> result = Collections2.transform(
				elements, CreateZDLWrapper.create(livelinessQosPolicy.class));
		return new ImmutableList.Builder<livelinessQosPolicy>().addAll(result)
				.build();

	}

	public List<durabilityQosPolicy> selectDurabilityQosPolicy(
			org.eclipse.uml2.uml.Package pkg) {
		final Collection<PackageableElement> elements = Collections2.filter(pkg
				.getPackagedElements(), new IsZDLConcept(
				"DDS::QOS::durabilityQosPolicy"));
		final Collection<durabilityQosPolicy> result = Collections2.transform(
				elements, CreateZDLWrapper.create(durabilityQosPolicy.class));
		return new ImmutableList.Builder<durabilityQosPolicy>().addAll(result)
				.build();
