...
/**
 * This is the item provider adapter for a {@link com.prismtech.domain.sca.ppls.vpm.Configuration} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ConfigurationItemProvider
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addGenerateDescriptorsPropertyDescriptor(object);
		}
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 VpmPackage.Literals.CONFIGURATION__NAME,
				 true,
				 false,
				 false,
	...
	/**
	 * This adds a property descriptor for the Generate Descriptors feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addGenerateDescriptorsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Configuration_generateDescriptors_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Configuration_generateDescriptors_feature", "_UI_Configuration_type"),
				 VpmPackage.Literals.CONFIGURATION__GENERATE_DESCRIPTORS,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(VpmPackage.Literals.CONFIGURATION__CONFIGURATION_POINTS);
		}
