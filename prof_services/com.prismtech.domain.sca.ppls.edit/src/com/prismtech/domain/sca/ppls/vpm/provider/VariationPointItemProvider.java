...
/**
 * This is the item provider adapter for a {@link com.prismtech.domain.sca.ppls.vpm.VariationPoint} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class VariationPointItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 VpmPackage.Literals.VARIATION_POINT__NAME,
				 false,
				 false,
				 false,
	...
	protected void addConstrainedElementsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_VariationPoint_constrainedElements_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_VariationPoint_constrainedElements_feature", "_UI_VariationPoint_type"),
				 VpmPackage.Literals.VARIATION_POINT__CONSTRAINED_ELEMENTS,
				 false,
				 false,
				 false,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_VariationPoint_id_feature", "_UI_VariationPoint_type"),
				 VpmPackage.Literals.VARIATION_POINT__ID,
				 false,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(VpmPackage.Literals.VARIATION_POINT__CONSTRAINED_ELEMENTS);
		}
