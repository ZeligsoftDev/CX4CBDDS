...
import com.prismtech.domain.sca.ppls.commands.AddVariationPointWithSettingsCommand;
...
public class AddVariationPointWithSettingsAction implements IObjectActionDelegate {
	...
	public void run(IAction action) {
		...
		ICommand command = new AddVariationPointWithSettingsCommand(eo);
		try {
