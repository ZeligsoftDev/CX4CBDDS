...
import com.prismtech.domain.sca.ppls.commands.AddVariationPointWithValueCommand;
...
public class AddVariationPointWithValueAction implements IObjectActionDelegate {
	...
	public void run(IAction action) {
		...
		ICommand command = new AddVariationPointWithValueCommand(eo);
		try {
