...
public class SourceModelDecorator extends LabelProvider implements
		ILabelDecorator {

	private static final String OVERLAY_IMAGE_PATH= "/icons/obj16/SourceModel.gif"; //$NON-NLS-1$
	...
	public static SourceModelDecorator getSourceModelDecorator() {
		IDecoratorManager decoratorManager = Activator.getDefault()
				.getWorkbench().getDecoratorManager();
		if (decoratorManager
				.getEnabled("com.prismtech.domain.sca.ppls.ui.decorators.SourceModelDecorator")) { //$NON-NLS-1$
			return (SourceModelDecorator) decoratorManager
					.getLabelDecorator("com.prismtech.domain.sca.ppls.ui.decorators.SourceModelDecorator"); //$NON-NLS-1$
		}
		return null;
	}
	...
	public void refresh() {
		...
		final SourceModelDecorator decorator = getSourceModelDecorator();
		if (decorator == null) {
			return;
		} else {
