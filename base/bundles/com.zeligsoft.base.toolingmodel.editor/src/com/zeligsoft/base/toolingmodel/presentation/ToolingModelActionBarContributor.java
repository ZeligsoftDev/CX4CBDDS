...
/**
 * This is the action bar contributor for the ToolingModel model editor.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ToolingModelActionBarContributor extends
	 ...
	 * @generated
	 */
	public ToolingModelActionBarContributor() {
	...
	public void contributeToToolBar(IToolBarManager toolBarManager) {
		toolBarManager.add(new Separator("toolingmodel-settings")); //$NON-NLS-1$
		toolBarManager.add(new Separator("toolingmodel-additions")); //$NON-NLS-1$
	}
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		IMenuManager submenuManager = new MenuManager(
				ToolingModelEditorPlugin.INSTANCE
						.getString("_UI_ToolingModelEditor_menu"), "com.zeligsoft.base.toolingmodelMenuID"); //$NON-NLS-1$ //$NON-NLS-2$
	...
	public void menuAboutToShow(IMenuManager menuManager) {
		...
		submenuManager = new MenuManager(ToolingModelEditorPlugin.INSTANCE
				.getString("_UI_CreateChild_menu_item")); //$NON-NLS-1$
