 ...
 * @generated
 */
public class ComponentInterfacerealizationStructuralRealizationViewFactory
    ...
    protected void decorateView(View containerView, View view,
        ...
        view.setType(ZMLSemanticHints.SH_ZMLCOMPONENTINTERFACEREALIZATIONSTRUCTURALREALIZATIONEDITPART);

        getViewService().createNode(semanticAdapter, view,
            ZMLSemanticHints.SH_ZMLCOMPONENTINTERFACEREALIZATIONSTRUCTURALREALIZATIONLABELEDITPART,
