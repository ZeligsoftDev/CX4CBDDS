 ...
 *
 */
package com.zeligsoft.domain.zml.rsm.tooling.wizards;
 ...
 * @generated
 */
public class ZMLTemplateModelHandler
    ...
    protected boolean preFileCreation(IProgressMonitor monitor, TemplateConfiguration config) {
        config.addContentCreator("com.zeligsoft.domain.zml.rsm.tooling.contentCreator", new IContentCreator() { //$NON-NLS-1$
            ...
            public IStatus createContent(IProgressMonitor progressMonitor,
                ...
                if (resources.length > 0) {
                    ...
                    if (model != null) {
                        ...
                        model.applyProfile(ZMLUtil.getProfile());
                    }
                }
    ...
    protected boolean postFileCreation(IProgressMonitor progressMonitor, IFile[] files) {
        ...
        if (!enabledIds.contains(ZMLUtil.ZML_CORE_ACTIVITY_ID)) {
            enabledIds = new HashSet(enabledIds);
            enabledIds.add(ZMLUtil.ZML_CORE_ACTIVITY_ID);
