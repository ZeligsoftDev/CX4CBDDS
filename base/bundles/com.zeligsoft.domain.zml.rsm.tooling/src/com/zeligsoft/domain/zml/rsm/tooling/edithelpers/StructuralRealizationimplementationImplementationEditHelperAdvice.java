 ...
 * @generated
 */
public class StructuralRealizationimplementationImplementationEditHelperAdvice extends
    ...
    public ICommand getBeforeEditContextCommand(GetEditContextRequest request) {
        request.setEditContext(ZMLElementTypes.STRUCTURALREALIZATION_IMPLEMENTATION);
    ...
    protected ICommand getBeforeCreateRelationshipCommand(
        ...
        return new AbstractTransactionalCommand(request.getEditingDomain(),
            ...
            protected CommandResult doExecuteWithResult(
                ...
                ((EList)sApp.eGet(sApp.eClass().getEStructuralFeature("implementation"))).add(request.getTarget()); //$NON-NLS-1$
