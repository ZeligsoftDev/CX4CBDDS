 ...
 * @generated
 */
public class WorkerFunctionreceivingPortMessagePortViewFactory
    ...
    protected void decorateView(View containerView, View view,
        ...
        view.setType(ZMLSemanticHints.SH_ZMLWORKERFUNCTIONRECEIVINGPORTMESSAGEPORTEDITPART);

        getViewService().createNode(semanticAdapter, view,
            ZMLSemanticHints.SH_ZMLWORKERFUNCTIONRECEIVINGPORTMESSAGEPORTLABELEDITPART,
