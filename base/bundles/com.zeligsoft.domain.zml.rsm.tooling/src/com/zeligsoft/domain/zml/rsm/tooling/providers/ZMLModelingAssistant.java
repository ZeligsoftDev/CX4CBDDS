 ...
 * @generated
 */
public class ZMLModelingAssistant extends ModelingAssistantProvider {
    ...
    public List getRelTypesOnSource(IAdaptable source) {
        ...
        if (eObject != null) {
            ...
            for (int i = 0; i < ZMLElementTypes.RELATIONSHIP_TYPES.length; ++i) {
                ...
                if (ZMLElementTypes.matchesSource(elementType, eObject)) {
    ...
    public List getRelTypesOnSourceAndTarget(IAdaptable source, IAdaptable target) {
        ...
        if (sourceEObject != null && targetEObject != null) {
            ...
            for (int i = 0; i < ZMLElementTypes.RELATIONSHIP_TYPES.length; ++i) {
                IElementType elementType = ZMLElementTypes.RELATIONSHIP_TYPES[i];
                if (ZMLElementTypes.matchesSource(elementType, sourceEObject) &&
                        ZMLElementTypes.matchesTarget(elementType, targetEObject)) {
                    result.add(elementType);
                }
            }
            return result;
    ...
    public List getRelTypesOnTarget(IAdaptable target) {
        ...
        if (eObject != null) {
            ...
            for (int i = 0; i < ZMLElementTypes.RELATIONSHIP_TYPES.length; ++i) {
                IElementType elementType = ZMLElementTypes.RELATIONSHIP_TYPES[i];
                if (ZMLElementTypes.matchesTarget(elementType, eObject)) {
                    result.add(elementType);
                }
            }
            return result;
    ...
    public List getTypesForSource(IAdaptable target, IElementType relationshipType) {
        EObject eObject = (EObject)target.getAdapter(EObject.class);
        if (eObject != null) {
            return removeAbstractTypes(ZMLElementTypes.getSources(relationshipType), eObject);
        }
        return Collections.EMPTY_LIST;
    }
    ...
    public List getTypesForTarget(IAdaptable source, IElementType relationshipType) {
        EObject eObject = (EObject)source.getAdapter(EObject.class);
        if (eObject != null) {
            return removeAbstractTypes(ZMLElementTypes.getTargets(relationshipType), eObject);
        }
        return Collections.EMPTY_LIST;
    }
    ...
    public EObject selectExistingElementForSource(IAdaptable target,
        ...
        EObject eObject = (EObject)target.getAdapter(EObject.class);
        if (eObject != null) {
            List sourceTypes = Arrays.asList(ZMLElementTypes.getSources(relationshipType));
    ...
    public EObject selectExistingElementForTarget(IAdaptable source,
        ...
        EObject eObject = (EObject)source.getAdapter(EObject.class);
        if (eObject != null) {
            List targetTypes = Arrays.asList(ZMLElementTypes.getTargets(relationshipType));
