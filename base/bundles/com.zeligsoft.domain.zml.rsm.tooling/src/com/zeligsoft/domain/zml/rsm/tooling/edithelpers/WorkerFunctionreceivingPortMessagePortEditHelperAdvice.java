 ...
 * @generated
 */
public class WorkerFunctionreceivingPortMessagePortEditHelperAdvice extends
    ...
    public ICommand getBeforeEditContextCommand(GetEditContextRequest request) {
        request.setEditContext(ZMLElementTypes.WORKERFUNCTION_RECEIVINGPORT);
    ...
    protected ICommand getBeforeCreateRelationshipCommand(
        ...
        return new AbstractTransactionalCommand(request.getEditingDomain(),
            ...
            protected CommandResult doExecuteWithResult(
                ...
                sApp.eSet(sApp.eClass().getEStructuralFeature("receivingPort"), request.getTarget()); //$NON-NLS-1$
