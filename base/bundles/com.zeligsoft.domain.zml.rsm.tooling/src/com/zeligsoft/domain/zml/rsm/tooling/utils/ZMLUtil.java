 ...
 *
 */
package com.zeligsoft.domain.zml.rsm.tooling.utils;
...
public class ZMLUtil {
     ...
     * @generated
     */
    public static final String ZML_TOOLING_ACTIVITY_ID = "com.zeligsoft.domain.zml.rsm.tooling.uireduction.activity"; // $NON-NLS-1$
    
    /**
     * @generated
     */
    public static final String ZML_CORE_ACTIVITY_ID = "com.zeligsoft.domain.zml.rsm.tooling.core.activity"; // $NON-NLS-1$
    
    /**
     * @generated
     */
    public static final String PROFILE_NAME = "ZML"; // $NON-NLS-1$
    
    /**
     * @generated
     */
    public static final URI PROFILE_URI = URI.createURI("pathmap://ZML_PROFILES/ZML.profile.uml"); //$NON-NLS-1$
    ...
    public static ImageDescriptor getImageDescriptor(String imageFilePath) {
        ...
        URL result = ZMLPlugin.getDefault().getBundle().getEntry(imageFilePath);
        ...
        return new ImageDescriptor() {
            public ImageData getImageData() {
            	try {
            		...
            		ZMLPlugin.getDefault().getLog().log(new Status(IStatus.ERROR, ZMLPlugin.ID, -1, "getImage Failed", e)); //$NON-NLS-1$
            	}
