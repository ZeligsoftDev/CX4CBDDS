 ...
 * @generated
 */
public class StructuralRealizationimplementationImplementationViewFactory
    ...
    protected void decorateView(View containerView, View view,
        ...
        view.setType(ZMLSemanticHints.SH_ZMLSTRUCTURALREALIZATIONIMPLEMENTATIONIMPLEMENTATIONEDITPART);

        getViewService().createNode(semanticAdapter, view,
            ZMLSemanticHints.SH_ZMLSTRUCTURALREALIZATIONIMPLEMENTATIONIMPLEMENTATIONLABELEDITPART,
