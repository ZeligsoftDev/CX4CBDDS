 ...
 *
 */
public class BaseViewCustomizer implements IViewCustomizer{	
	...
	/* (non-Javadoc)
	 * @see com.zeligsoft.base.rsm.tooling.providers.IViewCustomizer#customizeView(org.eclipse.gmf.runtime.notation.View)
	 */
	public void customizeView(View view) {		
		//stereotype style 
		//Set to show only the decoration "ICON".
		UMLStereotypeStyle stereotypeShowStyle = (UMLStereotypeStyle) 
			view.getStyle(UmlnotationPackage.Literals.UML_STEREOTYPE_STYLE);
		if (stereotypeShowStyle != null){
			stereotypeShowStyle.setShowStereotype(UMLStereotypeDisplay.ICON_LITERAL);
		}		
	}
