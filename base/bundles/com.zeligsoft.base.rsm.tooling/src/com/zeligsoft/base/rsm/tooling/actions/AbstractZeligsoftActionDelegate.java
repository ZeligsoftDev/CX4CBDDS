...
import com.zeligsoft.base.rsm.tooling.utils.ModelerContentDescriber;
...
public abstract class AbstractZeligsoftActionDelegate
	...
	protected void doRun(IProgressMonitor progressMonitor) {
		...
		if (result != null) {
			NavigatorInlineEditUtil.startInlineEdit((EObject) result
				.getReturnValue(), new ModelerContentDescriber());
		}
