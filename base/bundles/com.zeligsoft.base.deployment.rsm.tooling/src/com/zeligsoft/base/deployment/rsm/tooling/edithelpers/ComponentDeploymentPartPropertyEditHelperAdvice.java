 ...
 * @generated
 */
public class ComponentDeploymentPartPropertyEditHelperAdvice extends
        ZeligsoftDeploymentBaseEditHelperAdvice {
    ...
    protected String getLocalizedName(EObject eObject) {
        ...
        Stereotype stereotype = element.getAppliedStereotype(ZeligsoftDeploymentElementTypes._COMPONENTDEPLOYMENTPART__PROPERTY.getStereotypeName());
