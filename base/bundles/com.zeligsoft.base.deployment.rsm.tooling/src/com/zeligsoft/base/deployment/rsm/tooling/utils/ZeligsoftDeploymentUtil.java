 ...
 *
 */
package com.zeligsoft.base.deployment.rsm.tooling.utils;
...
import com.zeligsoft.base.deployment.rsm.tooling.ZeligsoftDeploymentPlugin;

/**
 * @generated
 */
public class ZeligsoftDeploymentUtil {

	/**
	 * @generated
	 */
	public static final String ZELIGSOFTDEPLOYMENT_TOOLING_ACTIVITY_ID = "com.zeligsoft.base.deployment.rsm.tooling.uireduction.activity"; // $NON-NLS-1$

	/**
	 * @generated
	 */
	public static final String ZELIGSOFTDEPLOYMENT_CORE_ACTIVITY_ID = "com.zeligsoft.base.deployment.rsm.tooling.core.activity"; // $NON-NLS-1$

	/**
	 * @generated
	 */
	public static final String PROFILE_NAME = "ZeligsoftDeployment"; // $NON-NLS-1$

	/**
	 * @generated
	 */
	public static final URI PROFILE_URI = URI.createURI("pathmap://ZELIGSOFT_DEPLOYMENT/ZeligsoftDeployment.profile.uml"); //$NON-NLS-1$
	...
	public static ImageDescriptor getImageDescriptor(String imageFilePath) {
        ...
        URL result = ZeligsoftDeploymentPlugin.getDefault().getBundle().getEntry(imageFilePath);
	 ...
	 * @generated
	 */
	private static InputStream getStereotypeImageStream(String stereotypeName,
			ResourceSet resourceSet) {
	 ...
	 * @generated
	 */
	private static ImageDescriptor getImage(IElementType elementType,
			ResourceSet resourceSet, final int width, final int height) {
        ...
        return new ImageDescriptor() {
            public ImageData getImageData() {
            	try {
            		...
            		ZeligsoftDeploymentPlugin.getDefault().getLog().log(new Status(IStatus.ERROR, ZeligsoftDeploymentPlugin.ID, -1, "getImage Failed", e)); //$NON-NLS-1$
            	}
