 ...
 * @generated
 */
public class ZeligsoftDeploymentContributionItemProvider
    ...
    protected IMenuManager createMenuManager(
        ...
        if (menuId.equals("Add_Zeligsoft_Deployment")) //$NON-NLS-1$
            return new ActionMenuManager("Add_Zeligsoft_Deployment", //$NON-NLS-1$
                    new MenuAction(ZeligsoftDeploymentMessages.MenuManager_AddAction_text),
                    true);
    ...
    protected IAction createAction(
        ...
        if (editorPart instanceof IDiagramWorkbenchPart) {
            ...
            if (actionId.equals("Deployment_Part")) { //$NON-NLS-1$
                return new CreateElementAction(workbenchPage,
                    ZeligsoftDeploymentElementTypes._DEPLOYMENTPART__PROPERTY,
                    "Deployment_Part", //$NON-NLS-1$
                    ZeligsoftDeploymentMessages.MenuManager_CreateAction__DeploymentPart__Property_name,
                    ZeligsoftDeploymentUtil.getSmallImage(ZeligsoftDeploymentElementTypes._DEPLOYMENTPART__PROPERTY, resourceSet));                    
            }
            else if (actionId.equals("Component_Deployment_Part")) { //$NON-NLS-1$
                return new CreateElementAction(workbenchPage,
                    ZeligsoftDeploymentElementTypes._COMPONENTDEPLOYMENTPART__PROPERTY,
                    "Component_Deployment_Part", //$NON-NLS-1$
                    ZeligsoftDeploymentMessages.MenuManager_CreateAction__ComponentDeploymentPart__Property_name,
                    ZeligsoftDeploymentUtil.getSmallImage(ZeligsoftDeploymentElementTypes._COMPONENTDEPLOYMENTPART__PROPERTY, resourceSet));                    
            }
        }
