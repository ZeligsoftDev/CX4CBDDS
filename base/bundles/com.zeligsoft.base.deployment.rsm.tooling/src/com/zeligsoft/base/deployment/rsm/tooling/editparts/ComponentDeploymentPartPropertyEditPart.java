 ...
 * @generated
 */
public class ComponentDeploymentPartPropertyEditPart
     ...
     * @generated
     */
    public ComponentDeploymentPartPropertyEditPart(View view) {
        super(view);
    }
    ...
    protected void addChildVisual(EditPart child, int index) {
        if (child instanceof ComponentDeploymentPartPropertyTextEditPart) {
            ((ComponentDeploymentPartPropertyTextEditPart) child).setFigure(mainFigure.getNameFigure());
        } else {
