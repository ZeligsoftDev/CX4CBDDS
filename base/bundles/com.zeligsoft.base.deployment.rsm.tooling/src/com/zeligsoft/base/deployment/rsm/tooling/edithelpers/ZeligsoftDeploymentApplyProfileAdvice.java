 ...
 *
 */
package com.zeligsoft.base.deployment.rsm.tooling.edithelpers;
 ...
 * @generated
 */
public class ZeligsoftDeploymentApplyProfileAdvice
    ...
    protected ICommand getAfterCreateRelationshipCommand(
        ...
        if (request.getElementType() == UMLElementTypes.PROFILE_APPLICATION) {
            return new AbstractTransactionalCommand(request.getEditingDomain(),
                    ZeligsoftDeploymentMessages.CommandLabel_setProfileEditingCapabilities, null) {
                ...
                protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
                    ...
                    if (profileApplication.getAppliedProfile().equals(ZeligsoftDeploymentUtil.getProfile())) {
                        ...
                        if (hasEnabledEditingCapabilities ||
                            ...
                            requiredActivityIds.add(ZeligsoftDeploymentUtil.ZELIGSOFTDEPLOYMENT_TOOLING_ACTIVITY_ID);
                        ...
                        if (hasEnabledEditingCapabilities) {
                            ...
                            IPluginContribution contribution = new IPluginContribution() {
                                ...
                                public String getLocalId() {
                                    return ZeligsoftDeploymentUtil.ZELIGSOFTDEPLOYMENT_TOOLING_ACTIVITY_ID;
                                }
                                
                                public String getPluginId() {
                                    return ZeligsoftDeploymentPlugin.ID;
                                }
                            };
    ...
    protected ICommand getBeforeDestroyElementCommand(
        ...
        if (request.getElementToDestroy() instanceof ProfileApplication) {
            return new AbstractTransactionalCommand(request.getEditingDomain(),
                    ZeligsoftDeploymentMessages.CommandLabel_unsetProfileEditingCapabilities, null) {
                ...
                protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
                    ...
                    if (profileApplication.getAppliedProfile().equals(ZeligsoftDeploymentUtil.getProfile())) {
                        ...
                        if (EditingCapabilitiesUtil.hasEnabledEditingCapabilities(model) ||
                            ...
                            requiredActivityIds.remove(ZeligsoftDeploymentUtil.ZELIGSOFTDEPLOYMENT_TOOLING_ACTIVITY_ID);
                            EditingCapabilitiesUtil.setRequiredActivityIds(model, requiredActivityIds);
                            EditingCapabilitiesUtil.reenableActivities();
                        }
                    }
