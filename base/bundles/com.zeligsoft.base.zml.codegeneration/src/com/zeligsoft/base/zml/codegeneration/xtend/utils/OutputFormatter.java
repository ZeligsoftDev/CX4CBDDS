...
import com.zeligsoft.base.zml.codegeneration.Activator;
import com.zeligsoft.base.zml.codegeneration.l10n.Messages;
...
public class OutputFormatter {
	...
	static public void formatCFile( FileHandle file ) {
		...
		TextEdit edit = codeFormatter.format(
			CodeFormatter.K_COMPILATION_UNIT, doc.get(), 0, doc.get().length(),
			0, null);
