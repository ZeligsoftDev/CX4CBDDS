...
public class RSMUtilTest {
	...
	public void test_loadPackage_model() {
		...
		Model model = com.zeligsoft.base.util.RSMUtil.loadPackage(rset, URI
		...
		Model another = com.zeligsoft.base.util.RSMUtil.loadPackage(rset, URI
			.createURI(UMLResource.JAVA_PRIMITIVE_TYPES_LIBRARY_URI));
	...
	public void test_loadPackage_profile() {
		...
		Profile profile = com.zeligsoft.base.util.RSMUtil.loadPackage(rset, URI
		...
		// try loading again; make sure we don't somehow load a second instance
		Profile another = com.zeligsoft.base.util.RSMUtil.loadPackage(rset, URI
			.createURI(UMLResource.ECORE_PROFILE_URI));
