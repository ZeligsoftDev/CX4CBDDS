 ...
 * <ul>
 *   <li>{@link com.zeligsoft.base.langc.impl.FunctionImplementationImpl#getBody <em>Body</em>}</li>
 *   <li>{@link com.zeligsoft.base.langc.impl.FunctionImplementationImpl#getFunction <em>Function</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class FunctionImplementationImpl extends UserElementImpl implements FunctionImplementation {
	...
	protected boolean writeDefn(CodeWriter code) {
		...
		if( ! getFunction().getLinkage().write(code, false)
		 || ! code.space()
