 ...
 * <ul>
 *   <li>{@link com.zeligsoft.base.langc.impl.IndexExprImpl#getIndex <em>Index</em>}</li>
 *   <li>{@link com.zeligsoft.base.langc.impl.IndexExprImpl#getArray <em>Array</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class IndexExprImpl extends ExpressionImpl implements IndexExpr {
	...
	public ElementReference basicGetType() {
		if( type == null ) {
			type = (ElementReference)EcoreUtil.copy( getArray().getType() );
