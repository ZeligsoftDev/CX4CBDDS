 ...
 * <ul>
 *   <li>{@link com.zeligsoft.base.langc.impl.ElementReferenceImpl#getElement <em>Element</em>}</li>
 *   <li>{@link com.zeligsoft.base.langc.impl.ElementReferenceImpl#getCvQualifier <em>Cv Qualifier</em>}</li>
 *   <li>{@link com.zeligsoft.base.langc.impl.ElementReferenceImpl#getPointerSpec <em>Pointer Spec</em>}</li>
 *   <li>{@link com.zeligsoft.base.langc.impl.ElementReferenceImpl#getArrayBounds <em>Array Bounds</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ElementReferenceImpl extends BindableValueImpl implements ElementReference {
	...
	public boolean write(CodeWriter code, String name) {
		return getCvQualifier().write(code)
			&& code.space()
			&& getElement().write(code, name, getPointerSpec(), getArrayBounds());
	}
