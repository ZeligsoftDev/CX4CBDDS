...
public class ParticipantEndZImpl extends ConnectorEndZImpl implements
		ParticipantEnd {
	...
	public DataReaderWriter getReaderWriter() {
		if (_readerWriter == null) {
			final Object rawValue = com.zeligsoft.base.zdl.util.ZDLUtil
					.getValue(eObject(), "DDS::DCPS::ParticipantEnd",
							"readerWriter");
			if (rawValue instanceof org.eclipse.emf.ecore.EObject) {
				_readerWriter = ZDLFactoryRegistry.INSTANCE.create(
	...
	public void setReaderWriter(DataReaderWriter val) {
		ZDLUtil.setValue(element, "DDS::DCPS::ParticipantEnd", "readerWriter",
				val.eObject());
	}
		...
		if (_participant == null) {
			final Object rawValue = com.zeligsoft.base.zdl.util.ZDLUtil
					.getValue(eObject(), "DDS::DCPS::ParticipantEnd",
							"participant");
			if (rawValue instanceof org.eclipse.emf.ecore.EObject) {
				_participant = ZDLFactoryRegistry.INSTANCE.create(
						(org.eclipse.emf.ecore.EObject) rawValue,
	...
	public void setParticipant(DomainParticipant val) {
		ZDLUtil.setValue(element, "DDS::DCPS::ParticipantEnd", "participant",
				val.eObject());
	}
