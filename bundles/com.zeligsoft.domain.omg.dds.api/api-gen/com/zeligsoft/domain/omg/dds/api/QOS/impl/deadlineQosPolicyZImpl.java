...
public class deadlineQosPolicyZImpl extends qosPolicyZImpl implements
	...
	public void setPeriod(Duration val) {
		ZDLUtil.setValue(element, "DDS::QOS::deadlineQosPolicy", "period",
				val.eObject());
	}

	@Override
	public <T extends Duration> T createPeriod(Class<T> typeToCreate,
			String concept) {
		org.eclipse.emf.ecore.EObject newConcept = ZDLUtil.createZDLConcept(
				element, "DDS::QOS::deadlineQosPolicy", "period", concept);
	...
	public Duration createPeriod() {
		org.eclipse.emf.ecore.EObject newConcept = ZDLUtil.createZDLConcept(
				element, "DDS::QOS::deadlineQosPolicy", "period",
				"DDS::QOS::Duration");
