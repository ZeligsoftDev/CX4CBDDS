...
public class presentationQosPolicyZImpl extends qosPolicyZImpl implements presentationQosPolicy {
	...
	public PresentationQosPolicyAccessScopeKind getAccess_scope() {
		final Object rawValue = com.zeligsoft.base.zdl.util.ZDLUtil.getValue(eObject(),
				"DDS::QOS::presentationQosPolicy", "access_scope");

		if (_access_scope == null) {
			if (rawValue instanceof org.eclipse.emf.ecore.EObject) {
				_access_scope = PresentationQosPolicyAccessScopeKind.create((org.eclipse.emf.ecore.EObject) rawValue);
			}
		}
	...
	public void setAccess_scope(PresentationQosPolicyAccessScopeKind val) {
		ZDLUtil.setValue(element, "DDS::QOS::presentationQosPolicy", "access_scope", val.eObject(element));
	}

	@Override
	public Boolean getOrdered_access() {
		final Object rawValue = com.zeligsoft.base.zdl.util.ZDLUtil.getValue(eObject(),
				"DDS::QOS::presentationQosPolicy", "ordered_access");
		return (Boolean) rawValue;
	}

	@Override
	public void setOrdered_access(Boolean val) {
		ZDLUtil.setValue(element, "DDS::QOS::presentationQosPolicy", "ordered_access", val);
	}

	@Override
	public Boolean getCoherent_access() {
		final Object rawValue = com.zeligsoft.base.zdl.util.ZDLUtil.getValue(eObject(),
				"DDS::QOS::presentationQosPolicy", "coherent_access");
		return (Boolean) rawValue;
	}

	@Override
	public void setCoherent_access(Boolean val) {
		ZDLUtil.setValue(element, "DDS::QOS::presentationQosPolicy", "coherent_access", val);
	}
