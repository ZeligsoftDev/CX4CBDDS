...
public class reliabilityQosPolicyZImpl extends qosPolicyZImpl implements
	...
	public void setKind(RealiabilityQosPolicyKind val) {
		ZDLUtil.setValue(element, "DDS::QOS::reliabilityQosPolicy", "kind",
				val.eObject(element));
	}
	...
	public void setMax_blocking_time(Duration val) {
		ZDLUtil.setValue(element, "DDS::QOS::reliabilityQosPolicy",
				"max_blocking_time", val.eObject());
	}

	@Override
	public <T extends Duration> T createMax_blocking_time(
			Class<T> typeToCreate, String concept) {
		org.eclipse.emf.ecore.EObject newConcept = ZDLUtil.createZDLConcept(
				element, "DDS::QOS::reliabilityQosPolicy", "max_blocking_time",
				concept);
