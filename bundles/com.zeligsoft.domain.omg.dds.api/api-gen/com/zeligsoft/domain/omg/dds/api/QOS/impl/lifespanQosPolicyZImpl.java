...
public class lifespanQosPolicyZImpl extends qosPolicyZImpl implements
	...
	public void setDuration(Duration val) {
		ZDLUtil.setValue(element, "DDS::QOS::lifespanQosPolicy", "duration",
				val.eObject());
	}
	...
	public <T extends Duration> T createDuration(Class<T> typeToCreate,
		...
		org.eclipse.emf.ecore.EObject newConcept = ZDLUtil.createZDLConcept(
				element, "DDS::QOS::lifespanQosPolicy", "duration", concept);
	...
	public Duration createDuration() {
		org.eclipse.emf.ecore.EObject newConcept = ZDLUtil.createZDLConcept(
				element, "DDS::QOS::lifespanQosPolicy", "duration",
				"DDS::QOS::Duration");
