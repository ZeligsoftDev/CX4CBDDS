...
public class ownershipQosPolicyZImpl extends qosPolicyZImpl implements ownershipQosPolicy {
	...
	public OwnershipQosPolicyKind getKind() {
		final Object rawValue = com.zeligsoft.base.zdl.util.ZDLUtil.getValue(eObject(), "DDS::QOS::ownershipQosPolicy",
				"kind");

		if (_kind == null) {
			if (rawValue instanceof org.eclipse.emf.ecore.EObject) {
				_kind = OwnershipQosPolicyKind.create((org.eclipse.emf.ecore.EObject) rawValue);
			}
		}
		return _kind;
	}
	...
	public void setKind(OwnershipQosPolicyKind val) {
		ZDLUtil.setValue(element, "DDS::QOS::ownershipQosPolicy", "kind", val.eObject(element));
	}
