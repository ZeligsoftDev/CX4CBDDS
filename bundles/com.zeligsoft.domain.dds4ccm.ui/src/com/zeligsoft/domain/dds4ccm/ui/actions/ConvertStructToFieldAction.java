 ...
 *
 */
public class ConvertStructToFieldAction
	...
	public void run(IAction action) {
		...
		if( selObject != null && ZDLUtil.isZDLConcept(selObject, CORBADomainNames.CORBASTRUCT)) {
			...
			AbstractTransactionalCommand command = new ConvertStructToFieldCommand(
					selObject,
					Messages.ConvertStructToField_DialogTitle);
	 ...
	 *
	 */
	private class ConvertStructToFieldCommand extends
