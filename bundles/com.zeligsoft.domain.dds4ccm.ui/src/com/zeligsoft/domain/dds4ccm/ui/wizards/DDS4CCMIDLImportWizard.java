 ...
 * 
 */
public class DDS4CCMIDLImportWizard extends AbstractIDLImportWizard {
	...
	protected void initPage() {
		super.initPage();
		page.setRootDirectoryDialogSettingKey("DDS4CCMIDLImportRootDirectory"); //$NON-NLS-1$
		page.setTargetModelDialogSettingKey("DDS4CCMIDLImportTargetModel"); //$NON-NLS-1$
		page.setDefineDialogSettingKey("DDS4CCMIDLImportDefineInput"); //$NON-NLS-1$
		page.setIncludeDialogSettingKey("DDS4CCMIDLImportIncludeInput"); //$NON-NLS-1$
		page.setIncludeDialogSettingKey("DDS4CCMIDLImportExcludeInput"); //$NON-NLS-1$
	...
	private static class IDLImporter implements Runnable
	{
		...
		static {
			bundle = Platform.getBundle("com.zeligsoft.domain.dds4ccm.idlimport");//$NON-NLS-1$
		}
