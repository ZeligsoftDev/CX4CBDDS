 ...
 */
public class InterconnectDropStrategy extends TransactionalDropStrategy {

	/**
	 * Constructor.
	 */
	public InterconnectDropStrategy() {
	}

	@Override
	public String getLabel() {
		return "Interconnect drop to create InterconnectInstance";
	}

	@Override
	public String getDescription() {
		return "Interconnect drop to create CCMPart";
	}
	...
	@Override
	public String getID() {
		return com.zeligsoft.domain.dds4ccm.ui.Activator.PLUGIN_ID + ".InterconnectToInterconnectInstanceDrop";
	}
	...
	protected Command doGetCommand(Request request, EditPart targetEditPart) {
		...
		List<Component> handledDroppedObjects = getDroppedInterconnects(dropReq);
	...
	protected Command getCreateAndDropObjectCommand(EObject droppedObject, Component targetComponent, Point location,
		...
		IElementType type = ZDLElementTypeUtil.getElementType(targetComponent, CCMNames.INTERCONNECT_INSTANCE);
	...
	protected List<Component> getDroppedInterconnects(Request req) {
		List<EObject> droppedObjects = getSourceEObjects(req);
		List<Component> result = new ArrayList<Component>();
		if (droppedObjects != null) {
			for (EObject droppedObject : droppedObjects) {
				if (ZDLUtil.isZDLConcept(droppedObject, CCMNames.INTERCONNECT)) {
