...
public class IDLGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class Preproc_Pragma_Conn_TypeElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "Preproc_Pragma_Conn_Type");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Keyword cPragmaKeyword_0 = (Keyword)cGroup.eContents().get(0);
	...
	private final ParamDirectionElements unknownRuleParamDirection;
	...
	public IDLGrammarAccess(GrammarProvider grammarProvider) {
		...
		this.unknownRuleParamDirection = new ParamDirectionElements();
		...
		this.tUNUSED_LITERAL = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "UNUSED_LITERAL");
		...
		this.tHEX_ESCAPE = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "HEX_ESCAPE");
	...
	public ParamDirectionElements getParamDirectionAccess() {
		return unknownRuleParamDirection;
	}
