...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Param Dcl</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 ...
 * @generated
 */
public class ParamDclImpl extends EModelElementImpl implements ParamDcl
{
  /**
  ...
  {
    return IdlPackage.Literals.PARAM_DCL;
  }
  ...
  public void setDirection(ParamDirection newDirection)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, IdlPackage.PARAM_DCL__DIRECTION, oldDirection, direction));
  }
  ...
  public NotificationChain basicSetType(ParamTypeSpec newType, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, IdlPackage.PARAM_DCL__TYPE, oldType, newType);
  ...
  public void setType(ParamTypeSpec newType)
  {
    if (newType != type)
    {
      ...
      if (type != null)
        msgs = ((InternalEObject)type).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - IdlPackage.PARAM_DCL__TYPE, null, msgs);
      if (newType != null)
        msgs = ((InternalEObject)newType).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - IdlPackage.PARAM_DCL__TYPE, null, msgs);
      msgs = basicSetType(newType, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, IdlPackage.PARAM_DCL__TYPE, newType, newType));
  }
  ...
  public void setName(String newName)
  {
    ...
    name = newName;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, IdlPackage.PARAM_DCL__NAME, oldName, name));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case IdlPackage.PARAM_DCL__TYPE:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case IdlPackage.PARAM_DCL__DIRECTION:
        return getDirection();
      case IdlPackage.PARAM_DCL__TYPE:
        return getType();
      case IdlPackage.PARAM_DCL__NAME:
        return getName();
    }
