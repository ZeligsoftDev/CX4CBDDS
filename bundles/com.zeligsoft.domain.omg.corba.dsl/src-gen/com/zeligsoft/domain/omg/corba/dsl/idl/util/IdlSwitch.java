...
public class IdlSwitch<T> extends Switch<T>
{
  ...
  protected T doSwitch(int classifierID, EObject theEObject)
  {
    switch (classifierID)
    {
      ...
      case IdlPackage.PREPROC_PRAGMA_CONN_TYPE:
      {
        Preproc_Pragma_Conn_Type preproc_Pragma_Conn_Type = (Preproc_Pragma_Conn_Type)theEObject;
        T result = casePreproc_Pragma_Conn_Type(preproc_Pragma_Conn_Type);
        if (result == null) result = casePreproc_Pragma(preproc_Pragma_Conn_Type);
        if (result == null) result = casePreproc(preproc_Pragma_Conn_Type);
        if (result == null) result = caseDefinition(preproc_Pragma_Conn_Type);
        if (result == null) result = caseExport(preproc_Pragma_Conn_Type);
        if (result == null) result = caseComponentExport(preproc_Pragma_Conn_Type);
        if (result == null) result = caseHomeExport(preproc_Pragma_Conn_Type);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      ...
      {
        com.zeligsoft.domain.omg.corba.dsl.idl.Module module = (com.zeligsoft.domain.omg.corba.dsl.idl.Module)theEObject;
  ...
  /**
   * Returns the result of interpreting the object as an instance of '<em>Preproc Pragma Conn Type</em>'.
   * <!-- begin-user-doc -->
   * This implementation returns null;
   * returning a non-null result will terminate the switch.
   * <!-- end-user-doc -->
   * @param object the target of the switch.
   * @return the result of interpreting the object as an instance of '<em>Preproc Pragma Conn Type</em>'.
   * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
   * @generated
   */
  public T casePreproc_Pragma_Conn_Type(Preproc_Pragma_Conn_Type object)
  {
    return null;
  }
   ...
   * @generated
   */
  public T caseModule(com.zeligsoft.domain.omg.corba.dsl.idl.Module object)
  {
    return null;
  }
