 ...
 * @generated
 */
public class DeclaratorImpl extends EModelElementImpl implements Declarator
{
  /**
  ...
  public void setId(String newId)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, IdlPackage.DECLARATOR__ID, oldId, id));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case IdlPackage.DECLARATOR__ID:
        return getId();
    }
