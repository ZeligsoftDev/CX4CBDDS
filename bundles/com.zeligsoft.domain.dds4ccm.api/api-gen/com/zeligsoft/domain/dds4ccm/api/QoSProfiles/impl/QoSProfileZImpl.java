...
public class QoSProfileZImpl extends NamedElementImplementation implements QoSProfile {
	...
	public String getFilename() {
		final Object rawValue = com.zeligsoft.base.zdl.util.ZDLUtil.getValue(eObject(),
				"DDS4CCM::QoSProfiles::QoSProfile", "filename");
		...
		if (_qosForEntity == null) {
			...
			for (Object next : rawList) {
				if (next instanceof org.eclipse.emf.ecore.EObject) {
					QoSForEntity nextWrapper = ZDLFactoryRegistry.INSTANCE.create((org.eclipse.emf.ecore.EObject) next,
							QoSForEntity.class);
	...
	public <T extends QoSForEntity> T addQosForEntity(Class<T> typeToCreate, String concept) {
		// make sure the qosForEntity list is created
		getQosForEntity();
		org.eclipse.emf.ecore.EObject newConcept = ZDLUtil.createZDLConcept(element, "DDS4CCM::QoSProfiles::QoSProfile",
				"qosForEntity", concept);
	...
	public java.util.List<QoSEntity> getQosEntity() {
		if (_qosEntity == null) {
			...
			for (Object next : rawList) {
				if (next instanceof org.eclipse.emf.ecore.EObject) {
					QoSEntity nextWrapper = ZDLFactoryRegistry.INSTANCE.create((org.eclipse.emf.ecore.EObject) next,
							QoSEntity.class);
	...
	public QoSEntity addQosEntity() {
		...
		getQosEntity();
		org.eclipse.emf.ecore.EObject newConcept = ZDLUtil.createZDLConcept(element, "DDS4CCM::QoSProfiles::QoSProfile",
				"qosEntity", "DDS4CCM::QoSProfiles::QoSEntity");
		QoSEntity element = ZDLFactoryRegistry.INSTANCE.create(newConcept,
				QoSEntity.class);
		if (_qosEntity != null) {
			_qosEntity.add(element);
		}
