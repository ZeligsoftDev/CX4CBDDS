...
public class DDSMessageZImpl
    extends CORBAStructImplementation implements DDSMessage{
    ...
    public java.util.List<MessageField> getFields(){
        if(_fields == null) {
            final Object rawValue = 
                com.zeligsoft.base.zdl.util.ZDLUtil.getValue(eObject(), "DDS4CCM::DDSExtensions::DDSMessage", "fields");
            _fields = new java.util.ArrayList<MessageField>();
            @SuppressWarnings("unchecked")
            final java.util.List<Object> rawList = (java.util.List<Object>) rawValue;
            for(Object next : rawList) {
                if(next instanceof org.eclipse.emf.ecore.EObject) {
                    MessageField nextWrapper = 
                         ZDLFactoryRegistry.INSTANCE.create((org.eclipse.emf.ecore.EObject) next, MessageField.class);
    ...
    public <T extends MessageField> T addFields(Class<T> typeToCreate, String concept){
    	...
    	org.eclipse.emf.ecore.EObject newConcept = 
    		ZDLUtil.createZDLConcept(element, "DDS4CCM::DDSExtensions::DDSMessage", "fields", concept);
    ...
    public MessageField addFields(){
    	...
    	getFields();
    	org.eclipse.emf.ecore.EObject newConcept = 
    		ZDLUtil.createZDLConcept(element, "DDS4CCM::DDSExtensions::DDSMessage", "fields", "DDS4CCM::DDSExtensions::MessageField");
    	MessageField element = ZDLFactoryRegistry.INSTANCE
    			.create((org.eclipse.emf.ecore.EObject) newConcept,
    					MessageField.class);
    	if(_fields != null) {
    		_fields.add(element);
