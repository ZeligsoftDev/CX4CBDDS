...
public class QoSEntityZImpl
    extends NamedElementImplementation implements QoSEntity{
    ...
    public QoSForEntity getType(){
        if(_type == null) {
            final Object rawValue = 
                com.zeligsoft.base.zdl.util.ZDLUtil.getValue(eObject(), "DDS4CCM::QoSProfiles::QoSEntity", "type");
            if(rawValue instanceof org.eclipse.emf.ecore.EObject) {
              _type = ZDLFactoryRegistry.INSTANCE.create((org.eclipse.emf.ecore.EObject)rawValue, QoSForEntity.class);
            }
        }
        return _type;
    }
