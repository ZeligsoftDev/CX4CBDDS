...
import com.zeligsoft.domain.omg.ccm.ui.viewcustomizers.CCMComponentViewCustomizer;
import com.zeligsoft.domain.omg.ccm.ui.viewcustomizers.CCMInterfaceViewCustomizer;
import com.zeligsoft.domain.zml.ui.viewcustomizers.ZMLComponentViewCustomizer;

/**
 * The default view provider for the CCM domain.
 * 
 * Provides for nodes of type uml.component and for nodes with CCM component
 * concepts.
 * 
 * @author schafe
 * 
 */
public class CCMDefaultViewProvider
	...
	static {
		nodeMap.put(UMLPackage.eINSTANCE.getComponent(),
			CCMComponentViewCustomizer.INSTANCE);
		nodeMap.put(UMLPackage.eINSTANCE.getInterface(),
			CCMInterfaceViewCustomizer.INSTANCE);
	}
