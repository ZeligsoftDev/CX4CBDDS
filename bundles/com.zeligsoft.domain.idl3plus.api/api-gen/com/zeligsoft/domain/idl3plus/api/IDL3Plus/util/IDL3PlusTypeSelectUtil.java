...
public class IDL3PlusTypeSelectUtil {
	public List<IDL3PlusModel> selectIDL3PlusModel(org.eclipse.uml2.uml.Package pkg) {
		...
		final Collection<IDL3PlusModel> result = Collections2.transform(elements,
				CreateZDLWrapper.create(IDL3PlusModel.class));
	...
	public List<ExtendedPortType> selectExtendedPortType(org.eclipse.uml2.uml.Package pkg) {
		...
		final Collection<ExtendedPortType> result = Collections2.transform(elements,
				CreateZDLWrapper.create(ExtendedPortType.class));
	...
	public List<ConnectorDef> selectConnectorDef(org.eclipse.uml2.uml.Package pkg) {
		...
		final Collection<ConnectorDef> result = Collections2.transform(elements,
				CreateZDLWrapper.create(ConnectorDef.class));
	...
	public List<ConnectorFragment> selectConnectorFragment(org.eclipse.uml2.uml.Package pkg) {
		...
		final Collection<ConnectorFragment> result = Collections2.transform(elements,
				CreateZDLWrapper.create(ConnectorFragment.class));
	...
	public List<FragmentImplementation> selectFragmentImplementation(org.eclipse.uml2.uml.Package pkg) {
		...
		final Collection<FragmentImplementation> result = Collections2.transform(elements,
	...
	public List<FragmentAssembly> selectFragmentAssembly(org.eclipse.uml2.uml.Package pkg) {
		...
		final Collection<FragmentAssembly> result = Collections2.transform(elements,
				CreateZDLWrapper.create(FragmentAssembly.class));
	...
	public List<ConnectorImplementation> selectConnectorImplementation(org.eclipse.uml2.uml.Package pkg) {
		...
		final Collection<ConnectorImplementation> result = Collections2.transform(elements,
	...
	public List<ConnectorAssembly> selectConnectorAssembly(org.eclipse.uml2.uml.Package pkg) {
		...
		final Collection<ConnectorAssembly> result = Collections2.transform(elements,
				CreateZDLWrapper.create(ConnectorAssembly.class));
	...
	public List<ConnectorDefaultValueBinding> selectConnectorDefaultValueBinding(org.eclipse.uml2.uml.Package pkg) {
		...
		final Collection<ConnectorDefaultValueBinding> result = Collections2.transform(elements,
				CreateZDLWrapper.create(ConnectorDefaultValueBinding.class));
	...
	public List<TemplateModule> selectTemplateModule(org.eclipse.uml2.uml.Package pkg) {
		...
		final Collection<TemplateModule> result = Collections2.transform(elements,
				CreateZDLWrapper.create(TemplateModule.class));
	...
	public List<ModuleInstantiation> selectModuleInstantiation(org.eclipse.uml2.uml.Package pkg) {
		...
		final Collection<ModuleInstantiation> result = Collections2.transform(elements,
				CreateZDLWrapper.create(ModuleInstantiation.class));
	...
	public List<TemplateParameterType> selectTemplateParameterType(org.eclipse.uml2.uml.Package pkg) {
		...
		final Collection<TemplateParameterType> result = Collections2.transform(elements,
