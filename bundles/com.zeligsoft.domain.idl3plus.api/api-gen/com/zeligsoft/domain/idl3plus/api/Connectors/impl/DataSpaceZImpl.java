...
public class DataSpaceZImpl
    extends NamedElementImplementation implements DataSpace{
    ...
    public ComponentInterface getDefinition(){
        if(_definition == null) {
            final Object rawValue = 
                com.zeligsoft.base.zdl.util.ZDLUtil.getValue(eObject(), "ZMLMM::ZML_Component::Part", "definition");
            if(rawValue instanceof org.eclipse.emf.ecore.EObject) {
              _definition = ZDLFactoryRegistry.INSTANCE.create((org.eclipse.emf.ecore.EObject)rawValue, ComponentInterface.class);
            }
        }
        return _definition;
    }
    ...
    public ConnectorDef getConnectorType(){
        if(_connectorType == null) {
            final Object rawValue = 
                com.zeligsoft.base.zdl.util.ZDLUtil.getValue(eObject(), "IDL3Plus::Connectors::DataSpace", "connectorType");
            if(rawValue instanceof org.eclipse.emf.ecore.EObject) {
              _connectorType = ZDLFactoryRegistry.INSTANCE.create((org.eclipse.emf.ecore.EObject)rawValue, ConnectorDef.class);
            }
        }
