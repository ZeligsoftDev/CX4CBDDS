...
public enum TypeConstraint {
	...
	public static TypeConstraint create(EObject literal) {
		if (literal == ZDLUtil.getZDLEnumLiteral(literal,
				"IDL3Plus::Generics::TypeConstraint", "typename")) { //$NON-NLS-1$//$NON-NLS-2$
			return TYPENAME;
		} else if (literal == ZDLUtil.getZDLEnumLiteral(literal,
				"IDL3Plus::Generics::TypeConstraint", "interface")) { //$NON-NLS-1$//$NON-NLS-2$
			return INTERFACE;
		} else if (literal == ZDLUtil.getZDLEnumLiteral(literal,
				"IDL3Plus::Generics::TypeConstraint", "valuetype")) { //$NON-NLS-1$//$NON-NLS-2$
			return VALUETYPE;
		} else if (literal == ZDLUtil.getZDLEnumLiteral(literal,
				"IDL3Plus::Generics::TypeConstraint", "eventtype")) { //$NON-NLS-1$//$NON-NLS-2$
			return EVENTTYPE;
		} else if (literal == ZDLUtil.getZDLEnumLiteral(literal,
				"IDL3Plus::Generics::TypeConstraint", "struct")) { //$NON-NLS-1$//$NON-NLS-2$
			return STRUCT;
		} else if (literal == ZDLUtil.getZDLEnumLiteral(literal,
				"IDL3Plus::Generics::TypeConstraint", "union")) { //$NON-NLS-1$//$NON-NLS-2$
			return UNION;
		} else if (literal == ZDLUtil.getZDLEnumLiteral(literal,
				"IDL3Plus::Generics::TypeConstraint", "sequence")) { //$NON-NLS-1$//$NON-NLS-2$
			return SEQUENCE;
		} else if (literal == ZDLUtil.getZDLEnumLiteral(literal,
				"IDL3Plus::Generics::TypeConstraint", "array")) { //$NON-NLS-1$//$NON-NLS-2$
			return ARRAY;
		} else if (literal == ZDLUtil.getZDLEnumLiteral(literal,
				"IDL3Plus::Generics::TypeConstraint", "enum")) { //$NON-NLS-1$//$NON-NLS-2$
			return ENUM;
		} else {
			return UNKNOWN;
		}
