...
public class TypedConnectorZImpl
    extends AssemblyConnectorImplementation implements TypedConnector{
    ...
    public ConnectorDef getConnectorType(){
        if(_connectorType == null) {
            final Object rawValue = 
                com.zeligsoft.base.zdl.util.ZDLUtil.getValue(eObject(), "IDL3Plus::Connectors::TypedConnector", "connectorType");
