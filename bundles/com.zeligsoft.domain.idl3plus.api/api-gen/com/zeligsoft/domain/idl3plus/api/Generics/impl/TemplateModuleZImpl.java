...
public class TemplateModuleZImpl extends CORBANamedElementImplementation
		implements TemplateModule {
	...
	public TemplateSignature getSignature() {
		if (_signature == null) {
			final Object rawValue = com.zeligsoft.base.zdl.util.ZDLUtil
					.getValue(eObject(), "IDL3Plus::Generics::TemplateModule",
							"signature");
			if (rawValue instanceof org.eclipse.emf.ecore.EObject) {
				_signature = ZDLFactoryRegistry.INSTANCE.create(
	...
	public void setSignature(TemplateSignature val) {
		ZDLUtil.setValue(element, "IDL3Plus::Generics::TemplateModule",
				"signature", val.eObject());
	}

	@Override
	public <T extends TemplateSignature> T createSignature(
			Class<T> typeToCreate, String concept) {
		org.eclipse.emf.ecore.EObject newConcept = ZDLUtil.createZDLConcept(
				element, "IDL3Plus::Generics::TemplateModule", "signature",
				concept);
	...
	public TemplateSignature createSignature() {
		...
		TemplateSignature element = ZDLFactoryRegistry.INSTANCE.create(
				newConcept,
				TemplateSignature.class);
		return element;
	}
