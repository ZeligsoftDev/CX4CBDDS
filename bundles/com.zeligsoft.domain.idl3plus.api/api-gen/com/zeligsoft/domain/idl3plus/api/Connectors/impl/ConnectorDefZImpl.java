...
public class ConnectorDefZImpl extends ComponentInterfaceImplementation
		implements ConnectorDef {
	...
	public java.util.List<ConnectorDef> getGeneral() {
		if (_general == null) {
			final Object rawValue = com.zeligsoft.base.zdl.util.ZDLUtil
					.getValue(eObject(), "IDL3Plus::Connectors::ConnectorDef",
							"general");
			...
			for (Object next : rawList) {
				if (next instanceof org.eclipse.emf.ecore.EObject) {
					ConnectorDef nextWrapper = ZDLFactoryRegistry.INSTANCE
	...
	public <T extends CORBAAttribute> T addOwnedAttribute(
		...
		org.eclipse.emf.ecore.EObject newConcept = ZDLUtil.createZDLConcept(
				element, "IDL3Plus::Connectors::ConnectorDef",
	...
	public CORBAAttribute addOwnedAttribute() {
		...
		org.eclipse.emf.ecore.EObject newConcept = ZDLUtil.createZDLConcept(
				element, "IDL3Plus::Connectors::ConnectorDef",
				"ownedAttribute", "CORBADomain::IDL::CORBAAttribute");
