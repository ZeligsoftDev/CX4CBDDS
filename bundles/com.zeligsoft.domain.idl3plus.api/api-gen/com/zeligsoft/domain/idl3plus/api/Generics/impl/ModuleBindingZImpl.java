...
public class ModuleBindingZImpl extends ZObjectImpl implements ModuleBinding {
	...
	public TemplateSignature getTemplate() {
		if (_template == null) {
			final Object rawValue = com.zeligsoft.base.zdl.util.ZDLUtil.getValue(eObject(),
					"IDL3Plus::Generics::ModuleBinding", "template");
			if (rawValue instanceof org.eclipse.emf.ecore.EObject) {
				_template = ZDLFactoryRegistry.INSTANCE.create((org.eclipse.emf.ecore.EObject) rawValue,
			...
			for (Object next : rawList) {
				if (next instanceof org.eclipse.emf.ecore.EObject) {
					ParameterBinding nextWrapper = ZDLFactoryRegistry.INSTANCE
							.create((org.eclipse.emf.ecore.EObject) next, ParameterBinding.class);
	...
	public <T extends ParameterBinding> T addParameterBinding(Class<T> typeToCreate, String concept) {
		...
		org.eclipse.emf.ecore.EObject newConcept = ZDLUtil.createZDLConcept(element,
				"IDL3Plus::Generics::ModuleBinding", "parameterBinding", concept);
	...
	public ParameterBinding addParameterBinding() {
		...
		getParameterBinding();
		org.eclipse.emf.ecore.EObject newConcept = ZDLUtil.createZDLConcept(element,
				"IDL3Plus::Generics::ModuleBinding", "parameterBinding", "IDL3Plus::Generics::ParameterBinding");
		ParameterBinding element = ZDLFactoryRegistry.INSTANCE.create(newConcept,
	...
	public ModuleInstantiation getBoundElement() {
		if (_boundElement == null) {
			final Object rawValue = com.zeligsoft.base.zdl.util.ZDLUtil.getValue(eObject(),
					"IDL3Plus::Generics::ModuleBinding", "boundElement");
			if (rawValue instanceof org.eclipse.emf.ecore.EObject) {
				_boundElement = ZDLFactoryRegistry.INSTANCE.create((org.eclipse.emf.ecore.EObject) rawValue,
