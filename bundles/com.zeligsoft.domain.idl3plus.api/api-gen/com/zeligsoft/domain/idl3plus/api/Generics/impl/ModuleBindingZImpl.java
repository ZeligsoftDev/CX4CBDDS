...
public class ModuleBindingZImpl
    extends ZObjectImpl implements ModuleBinding{
    ...
    public ModuleInstantiation getBoundElement(){
        if(_boundElement == null) {
            final Object rawValue = 
                com.zeligsoft.base.zdl.util.ZDLUtil.getValue(eObject(), "IDL3Plus::Generics::ModuleBinding", "boundElement");
            if(rawValue instanceof org.eclipse.emf.ecore.EObject) {
              _boundElement = ZDLFactoryRegistry.INSTANCE.create((org.eclipse.emf.ecore.EObject)rawValue, ModuleInstantiation.class);
            }
        }
    ...
    {
    				ZDLUtil.setValue(element, "IDL3Plus::Generics::ModuleBinding", "boundElement", val.eObject());
    			}
    public TemplateSignature getTemplate(){
        if(_template == null) {
            final Object rawValue = 
                com.zeligsoft.base.zdl.util.ZDLUtil.getValue(eObject(), "IDL3Plus::Generics::ModuleBinding", "template");
            if(rawValue instanceof org.eclipse.emf.ecore.EObject) {
              _template = ZDLFactoryRegistry.INSTANCE.create((org.eclipse.emf.ecore.EObject)rawValue, TemplateSignature.class);
            }
        }
        return _template;
    }
    ...
    {
    				ZDLUtil.setValue(element, "IDL3Plus::Generics::ModuleBinding", "template", val.eObject());
    			}
    public java.util.List<ParameterBinding> getParameterBinding(){
        if(_parameterBinding == null) {
            final Object rawValue = 
                com.zeligsoft.base.zdl.util.ZDLUtil.getValue(eObject(), "IDL3Plus::Generics::ModuleBinding", "parameterBinding");
            _parameterBinding = new java.util.ArrayList<ParameterBinding>();
            @SuppressWarnings("unchecked")
            final java.util.List<Object> rawList = (java.util.List<Object>) rawValue;
            for(Object next : rawList) {
                if(next instanceof org.eclipse.emf.ecore.EObject) {
                    ParameterBinding nextWrapper = 
                         ZDLFactoryRegistry.INSTANCE.create((org.eclipse.emf.ecore.EObject) next, ParameterBinding.class);
    ...
    public void addParameterBinding(ParameterBinding val){
    	...
    	final Object rawValue = ZDLUtil.getValue(element, "IDL3Plus::Generics::ModuleBinding", "parameterBinding");
    	@SuppressWarnings("unchecked")
    	final java.util.List<Object> rawList = (java.util.List<Object>) rawValue;
    ...
    public <T extends ParameterBinding> T addParameterBinding(Class<T> typeToCreate, String concept){
    	// make sure the parameterBinding list is created
    	getParameterBinding();
    	org.eclipse.emf.ecore.EObject newConcept = 
    		ZDLUtil.createZDLConcept(element, "IDL3Plus::Generics::ModuleBinding", "parameterBinding", concept);
    ...
    public ParameterBinding addParameterBinding(){
    	...
    	getParameterBinding();
    	org.eclipse.emf.ecore.EObject newConcept = 
    		ZDLUtil.createZDLConcept(element, "IDL3Plus::Generics::ModuleBinding", "parameterBinding", "IDL3Plus::Generics::ParameterBinding");
    	ParameterBinding element = ZDLFactoryRegistry.INSTANCE
    			.create((org.eclipse.emf.ecore.EObject) newConcept,
