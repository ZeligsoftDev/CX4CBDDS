...
public class ExtendedPortTypeZImpl
    extends CORBAModuleContainedImplementation implements ExtendedPortType{
    ...
    public PortType getInverse(){
        if(_inverse == null) {
            final Object rawValue = 
                com.zeligsoft.base.zdl.util.ZDLUtil.getValue(eObject(), "ZMLMM::ZML_Component::PortType", "inverse");
    ...
    public java.util.List<InterfaceRealization> getProvidedInterfaces(){
        if(_providedInterfaces == null) {
            final Object rawValue = 
                com.zeligsoft.base.zdl.util.ZDLUtil.getValue(eObject(), "ZMLMM::ZML_Component::PortType", "providedInterfaces");
            _providedInterfaces = new java.util.ArrayList<InterfaceRealization>();
            @SuppressWarnings("unchecked")
            final java.util.List<Object> rawList = (java.util.List<Object>) rawValue;
            for(Object next : rawList) {
                if(next instanceof org.eclipse.emf.ecore.EObject) {
                    InterfaceRealization nextWrapper = 
                         ZDLFactoryRegistry.INSTANCE.create((org.eclipse.emf.ecore.EObject) next, InterfaceRealization.class);
    ...
    public <T extends InterfaceRealization> T addProvidedInterfaces(Class<T> typeToCreate, String concept){
    	...
    	org.eclipse.emf.ecore.EObject newConcept = 
    		ZDLUtil.createZDLConcept(element, "ZMLMM::ZML_Component::PortType", "providedInterfaces", concept);
    ...
    public InterfaceRealization addProvidedInterfaces(){
    	...
    	getProvidedInterfaces();
    	org.eclipse.emf.ecore.EObject newConcept = 
    		ZDLUtil.createZDLConcept(element, "ZMLMM::ZML_Component::PortType", "providedInterfaces", "ZMLMM::ZML_Component::InterfaceRealization");
    	InterfaceRealization element = ZDLFactoryRegistry.INSTANCE
    			.create((org.eclipse.emf.ecore.EObject) newConcept,
    ...
    public java.util.List<CORBAAttribute> getOwnedAttribute(){
        if(_ownedAttribute == null) {
            final Object rawValue = 
                com.zeligsoft.base.zdl.util.ZDLUtil.getValue(eObject(), "IDL3Plus::IDL3Plus::ExtendedPortType", "ownedAttribute");
    ...
    public <T extends CORBAAttribute> T addOwnedAttribute(Class<T> typeToCreate, String concept){
    	...
    	getOwnedAttribute();
    	org.eclipse.emf.ecore.EObject newConcept = 
    		ZDLUtil.createZDLConcept(element, "IDL3Plus::IDL3Plus::ExtendedPortType", "ownedAttribute", concept);
    	T element = ZDLFactoryRegistry.INSTANCE
    			.create((org.eclipse.emf.ecore.EObject) newConcept,
    					typeToCreate);
    	if(_ownedAttribute != null) {
    ...
    public CORBAAttribute addOwnedAttribute(){
    	...
    	getOwnedAttribute();
    	org.eclipse.emf.ecore.EObject newConcept = 
    		ZDLUtil.createZDLConcept(element, "IDL3Plus::IDL3Plus::ExtendedPortType", "ownedAttribute", "CORBADomain::IDL::CORBAAttribute");
