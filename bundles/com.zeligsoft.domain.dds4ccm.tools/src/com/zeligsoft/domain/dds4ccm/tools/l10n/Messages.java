...
public class Messages extends NLS {
	...
	public static String ReferencesCustomPropertySection_ReferencedModelToolTip;
	public static String ReferencesCustomPropertySection_ReferencingModelTabLabl;
	public static String ReferencesCustomPropertySection_ReferencingModelToolTip;
