 ...
 * </p>
 * <ul>
 *   <li>{@link dds4ccm.impl.ownershipQosPolicyImpl#getKind <em>Kind</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ownershipQosPolicyImpl extends qosPolicyImpl implements ownershipQosPolicy {
	...
	protected EClass eStaticClass() {
		return DDS4CCMPackage.eINSTANCE.getownershipQosPolicy();
	}
	...
	public void setKind(OwnershipQosPolicyKind newKind) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DDS4CCMPackage.OWNERSHIP_QOS_POLICY__KIND, oldKind, kind));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DDS4CCMPackage.OWNERSHIP_QOS_POLICY__KIND:
				return getKind();
		}
