 ...
 * </p>
 * <ul>
 *   <li>{@link dds4ccm.impl.PropertyImpl#getValue <em>Value</em>}</li>
 *   <li>{@link dds4ccm.impl.PropertyImpl#getBase_Property <em>Base Property</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PropertyImpl extends TypedElementImpl implements Property {
	...
	protected EClass eStaticClass() {
		return DDS4CCMPackage.eINSTANCE.getProperty();
	}
	...
	public void setValue(String newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DDS4CCMPackage.PROPERTY__VALUE, oldValue, value));
	}
	...
	public org.eclipse.uml2.uml.Property getBase_Property() {
		if (base_Property != null && base_Property.eIsProxy()) {
			...
			if (base_Property != oldBase_Property) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DDS4CCMPackage.PROPERTY__BASE_PROPERTY, oldBase_Property, base_Property));
			}
		}
	...
	public void setBase_Property(org.eclipse.uml2.uml.Property newBase_Property) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DDS4CCMPackage.PROPERTY__BASE_PROPERTY, oldBase_Property, base_Property));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DDS4CCMPackage.PROPERTY__VALUE:
				return getValue();
			case DDS4CCMPackage.PROPERTY__BASE_PROPERTY:
