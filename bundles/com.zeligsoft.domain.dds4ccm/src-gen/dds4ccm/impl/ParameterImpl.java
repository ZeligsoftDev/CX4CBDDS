 ...
 * </p>
 * <ul>
 *   <li>{@link dds4ccm.impl.ParameterImpl#getBase_Parameter <em>Base Parameter</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ParameterImpl extends TypedElementImpl implements Parameter {
	...
	protected EClass eStaticClass() {
		return DDS4CCMPackage.eINSTANCE.getParameter();
	}
		...
		if (base_Parameter != null && base_Parameter.eIsProxy()) {
			...
			if (base_Parameter != oldBase_Parameter) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DDS4CCMPackage.PARAMETER__BASE_PARAMETER, oldBase_Parameter, base_Parameter));
			}
		}
	...
	public void setBase_Parameter(org.eclipse.uml2.uml.Parameter newBase_Parameter) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DDS4CCMPackage.PARAMETER__BASE_PARAMETER, oldBase_Parameter, base_Parameter));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DDS4CCMPackage.PARAMETER__BASE_PARAMETER:
