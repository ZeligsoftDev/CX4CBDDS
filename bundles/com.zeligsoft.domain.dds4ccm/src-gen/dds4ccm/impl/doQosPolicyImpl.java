...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>do Qos Policy</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link dds4ccm.impl.doQosPolicyImpl#getKind <em>Kind</em>}</li>
 * </ul>
 *
 * @generated
 */
public class doQosPolicyImpl extends qosPolicyImpl implements doQosPolicy {
	/**
	...
	protected EClass eStaticClass() {
		return DDS4CCMPackage.eINSTANCE.getdoQosPolicy();
	}
	...
	public void setKind(DestinationOrderQosPolicyKind newKind) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DDS4CCMPackage.DO_QOS_POLICY__KIND, oldKind, kind));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DDS4CCMPackage.DO_QOS_POLICY__KIND:
				return getKind();
		}
