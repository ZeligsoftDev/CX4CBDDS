...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>CX Struct</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link dds4ccm.impl.CXStructImpl#getExtensibility <em>Extensibility</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CXStructImpl extends CXConstructedImpl implements CXStruct {
	/**
	...
	protected EClass eStaticClass() {
		return DDS4CCMPackage.eINSTANCE.getCXStruct();
	}
	...
	public void setExtensibility(ExtensibilityKind newExtensibility) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DDS4CCMPackage.CX_STRUCT__EXTENSIBILITY, oldExtensibility, extensibility));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DDS4CCMPackage.CX_STRUCT__EXTENSIBILITY:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == Extensible.class) {
			switch (derivedFeatureID) {
				case DDS4CCMPackage.CX_STRUCT__EXTENSIBILITY: return DDS4CCMPackage.EXTENSIBLE__EXTENSIBILITY;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == Extensible.class) {
			switch (baseFeatureID) {
				case DDS4CCMPackage.EXTENSIBLE__EXTENSIBILITY: return DDS4CCMPackage.CX_STRUCT__EXTENSIBILITY;
				default: return -1;
			}
		}
		if (baseClass == Contained.class) {
