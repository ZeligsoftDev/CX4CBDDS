...
public class InterconnectImplementation
    extends NamedElementImplementation implements Interconnect{
    ...
    public java.util.List<ResourceProperty> getResource(){
        if(_resource == null) {
            final Object rawValue = 
                com.zeligsoft.base.zdl.util.ZDLUtil.getValue(eObject(), "CCM::CCM_Target::Interconnect", "resource");
            _resource = new java.util.ArrayList<ResourceProperty>();
            @SuppressWarnings("unchecked")
            final java.util.List<Object> rawList = (java.util.List<Object>) rawValue;
            for(Object next : rawList) {
                if(next instanceof org.eclipse.emf.ecore.EObject) {
                    ResourceProperty nextWrapper = 
                         ZDLFactoryRegistry.INSTANCE.create((org.eclipse.emf.ecore.EObject) next, ResourceProperty.class);
    ...
    public void addResource(ResourceProperty val){
    	...
    	final Object rawValue = ZDLUtil.getValue(element, "CCM::CCM_Target::Interconnect", "resource");
    	@SuppressWarnings("unchecked")
    	final java.util.List<Object> rawList = (java.util.List<Object>) rawValue;
    ...
    public <T extends ResourceProperty> T addResource(Class<T> typeToCreate, String concept){
    	...
    	org.eclipse.emf.ecore.EObject newConcept = 
    		ZDLUtil.createZDLConcept(element, "CCM::CCM_Target::Interconnect", "resource", concept);
    ...
    public ResourceProperty addResource(){
    	...
    	getResource();
    	org.eclipse.emf.ecore.EObject newConcept = 
    		ZDLUtil.createZDLConcept(element, "CCM::CCM_Target::Interconnect", "resource", "CCM::CCM_Target::ResourceProperty");
    	ResourceProperty element = ZDLFactoryRegistry.INSTANCE
    			.create((org.eclipse.emf.ecore.EObject) newConcept,
