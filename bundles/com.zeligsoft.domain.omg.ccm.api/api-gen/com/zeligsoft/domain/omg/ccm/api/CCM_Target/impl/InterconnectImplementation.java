...
public class InterconnectImplementation extends NamedElementImplementation implements Interconnect {
	...
	public <T extends ResourceProperty> T addResource(Class<T> typeToCreate, String concept) {
		// make sure the resource list is created
		getResource();
		org.eclipse.emf.ecore.EObject newConcept = ZDLUtil.createZDLConcept(element, "CCM::CCM_Target::Interconnect",
				"resource", concept);
