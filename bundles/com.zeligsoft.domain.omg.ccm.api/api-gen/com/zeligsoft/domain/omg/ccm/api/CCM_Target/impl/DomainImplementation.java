...
public class DomainImplementation extends NamedElementImplementation implements
		Domain {
	...
	public java.util.List<NodeInstance> getNode() {
		if (_node == null) {
			final Object rawValue = com.zeligsoft.base.zdl.util.ZDLUtil
					.getValue(eObject(), "CCM::CCM_Target::Domain", "node");
			_node = new java.util.ArrayList<NodeInstance>();
			@SuppressWarnings("unchecked")
			final java.util.List<Object> rawList = (java.util.List<Object>) rawValue;
			for (Object next : rawList) {
				if (next instanceof org.eclipse.emf.ecore.EObject) {
					NodeInstance nextWrapper = ZDLFactoryRegistry.INSTANCE
	...
	@Override
	public <T extends NodeInstance> T addNode(Class<T> typeToCreate,
			String concept) {
		// make sure the node list is created
		getNode();
		org.eclipse.emf.ecore.EObject newConcept = ZDLUtil.createZDLConcept(
				element, "CCM::CCM_Target::Domain", "node", concept);
	...
	public NodeInstance addNode() {
		...
		getNode();
		org.eclipse.emf.ecore.EObject newConcept = ZDLUtil.createZDLConcept(
				element, "CCM::CCM_Target::Domain", "node",
				"CCM::CCM_Target::NodeInstance");
		NodeInstance element = ZDLFactoryRegistry.INSTANCE.create(
				newConcept, NodeInstance.class);
		if (_node != null) {
			_node.add(element);
		}
		return element;
	...
	public java.util.List<CORBAAttribute> getInfoProperty() {
		if (_infoProperty == null) {
			final Object rawValue = com.zeligsoft.base.zdl.util.ZDLUtil
					.getValue(eObject(), "CCM::CCM_Target::Domain",
							"infoProperty");
	...
	public void addInfoProperty(CORBAAttribute val) {
		...
		final Object rawValue = ZDLUtil.getValue(element,
				"CCM::CCM_Target::Domain", "infoProperty");
		@SuppressWarnings("unchecked")
		final java.util.List<Object> rawList = (java.util.List<Object>) rawValue;
		rawList.add(val.eObject());
		if (_infoProperty != null) {
	...
	@Override
	public <T extends CORBAAttribute> T addInfoProperty(Class<T> typeToCreate,
			String concept) {
		// make sure the infoProperty list is created
		getInfoProperty();
		org.eclipse.emf.ecore.EObject newConcept = ZDLUtil.createZDLConcept(
				element, "CCM::CCM_Target::Domain", "infoProperty", concept);
		T element = ZDLFactoryRegistry.INSTANCE.create(
				newConcept, typeToCreate);
		if (_infoProperty != null) {
	...
	public CORBAAttribute addInfoProperty() {
		...
		getInfoProperty();
		org.eclipse.emf.ecore.EObject newConcept = ZDLUtil.createZDLConcept(
				element, "CCM::CCM_Target::Domain", "infoProperty",
	...
	public String getLabel() {
		final Object rawValue = com.zeligsoft.base.zdl.util.ZDLUtil.getValue(
				eObject(), "CCM::CCM_Target::Domain", "label");
	...
	public java.util.List<BridgeInstance> getBridge() {
		if (_bridge == null) {
			final Object rawValue = com.zeligsoft.base.zdl.util.ZDLUtil
					.getValue(eObject(), "CCM::CCM_Target::Domain", "bridge");
	...
	@Override
	public <T extends BridgeInstance> T addBridge(Class<T> typeToCreate,
			String concept) {
		// make sure the bridge list is created
		getBridge();
		org.eclipse.emf.ecore.EObject newConcept = ZDLUtil.createZDLConcept(
				element, "CCM::CCM_Target::Domain", "bridge", concept);
		T element = ZDLFactoryRegistry.INSTANCE.create(
				newConcept, typeToCreate);
		if (_bridge != null) {
			_bridge.add(element);
	...
	public BridgeInstance addBridge() {
		...
		getBridge();
		org.eclipse.emf.ecore.EObject newConcept = ZDLUtil.createZDLConcept(
				element, "CCM::CCM_Target::Domain", "bridge",
				"CCM::CCM_Target::BridgeInstance");
		BridgeInstance element = ZDLFactoryRegistry.INSTANCE.create(
				newConcept,
				BridgeInstance.class);
		if (_bridge != null) {
			_bridge.add(element);
	...
	public String getUUID() {
		final Object rawValue = com.zeligsoft.base.zdl.util.ZDLUtil.getValue(
				eObject(), "CCM::CCM_Target::Domain", "UUID");
		return (String) rawValue;
	}
	...
	public void addInterconnect(InterconnectInstance val) {
		...
		final Object rawValue = ZDLUtil.getValue(element,
				"CCM::CCM_Target::Domain", "interconnect");
		@SuppressWarnings("unchecked")
		final java.util.List<Object> rawList = (java.util.List<Object>) rawValue;
		rawList.add(val.eObject());
		if (_interconnect != null) {
	...
	@Override
	public <T extends InterconnectInstance> T addInterconnect(
			Class<T> typeToCreate, String concept) {
		// make sure the interconnect list is created
		getInterconnect();
		org.eclipse.emf.ecore.EObject newConcept = ZDLUtil.createZDLConcept(
				element, "CCM::CCM_Target::Domain", "interconnect", concept);
		T element = ZDLFactoryRegistry.INSTANCE.create(
				newConcept, typeToCreate);
		if (_interconnect != null) {
	...
	public InterconnectInstance addInterconnect() {
		...
		getInterconnect();
		org.eclipse.emf.ecore.EObject newConcept = ZDLUtil.createZDLConcept(
				element, "CCM::CCM_Target::Domain", "interconnect",
				"CCM::CCM_Target::InterconnectInstance");
		InterconnectInstance element = ZDLFactoryRegistry.INSTANCE.create(
				newConcept,
				InterconnectInstance.class);
		if (_interconnect != null) {
			_interconnect.add(element);
	...
	public void addSharedResource(SharedResource val) {
		...
		final Object rawValue = ZDLUtil.getValue(element,
				"CCM::CCM_Target::Domain", "sharedResource");
		@SuppressWarnings("unchecked")
		final java.util.List<Object> rawList = (java.util.List<Object>) rawValue;
		rawList.add(val.eObject());
		if (_sharedResource != null) {
	...
	@Override
	public <T extends SharedResource> T addSharedResource(
			Class<T> typeToCreate, String concept) {
		// make sure the sharedResource list is created
		getSharedResource();
		org.eclipse.emf.ecore.EObject newConcept = ZDLUtil.createZDLConcept(
				element, "CCM::CCM_Target::Domain", "sharedResource", concept);
		T element = ZDLFactoryRegistry.INSTANCE.create(
				newConcept, typeToCreate);
		if (_sharedResource != null) {
	...
	public SharedResource addSharedResource() {
		...
		getSharedResource();
		org.eclipse.emf.ecore.EObject newConcept = ZDLUtil.createZDLConcept(
				element, "CCM::CCM_Target::Domain", "sharedResource",
				"CCM::CCM_Target::SharedResource");
		SharedResource element = ZDLFactoryRegistry.INSTANCE.create(
				newConcept,
				SharedResource.class);
		if (_sharedResource != null) {
			_sharedResource.add(element);
	...
	public void addConnections(AssemblyConnector val) {
		...
		final Object rawValue = ZDLUtil.getValue(element,
				"CCM::CCM_Target::Domain", "connections");
		@SuppressWarnings("unchecked")
		final java.util.List<Object> rawList = (java.util.List<Object>) rawValue;
		rawList.add(val.eObject());
		if (_connections != null) {
	...
	@Override
	public <T extends AssemblyConnector> T addConnections(
			Class<T> typeToCreate, String concept) {
		// make sure the connections list is created
		getConnections();
		org.eclipse.emf.ecore.EObject newConcept = ZDLUtil.createZDLConcept(
				element, "CCM::CCM_Target::Domain", "connections", concept);
		T element = ZDLFactoryRegistry.INSTANCE.create(
				newConcept, typeToCreate);
		if (_connections != null) {
	...
	public AssemblyConnector addConnections() {
		...
		getConnections();
		org.eclipse.emf.ecore.EObject newConcept = ZDLUtil.createZDLConcept(
				element, "CCM::CCM_Target::Domain", "connections",
