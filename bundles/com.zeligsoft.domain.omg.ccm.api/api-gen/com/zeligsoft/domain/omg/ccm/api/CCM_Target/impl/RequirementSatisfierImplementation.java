...
public class RequirementSatisfierImplementation
    extends NamedElementImplementation implements RequirementSatisfier{
    ...
    public java.util.List<SatisfierProperty> getProperty(){
        if(_property == null) {
            final Object rawValue = 
                com.zeligsoft.base.zdl.util.ZDLUtil.getValue(eObject(), "CCM::CCM_Target::RequirementSatisfier", "property");
            _property = new java.util.ArrayList<SatisfierProperty>();
            @SuppressWarnings("unchecked")
            final java.util.List<Object> rawList = (java.util.List<Object>) rawValue;
            for(Object next : rawList) {
                if(next instanceof org.eclipse.emf.ecore.EObject) {
                    SatisfierProperty nextWrapper = 
                         ZDLFactoryRegistry.INSTANCE.create((org.eclipse.emf.ecore.EObject) next, SatisfierProperty.class);
    ...
    public <T extends SatisfierProperty> T addProperty(Class<T> typeToCreate, String concept){
    	...
    	org.eclipse.emf.ecore.EObject newConcept = 
    		ZDLUtil.createZDLConcept(element, "CCM::CCM_Target::RequirementSatisfier", "property", concept);
    ...
    public SatisfierProperty addProperty(){
    	...
    	getProperty();
    	org.eclipse.emf.ecore.EObject newConcept = 
    		ZDLUtil.createZDLConcept(element, "CCM::CCM_Target::RequirementSatisfier", "property", "CCM::CCM_Target::SatisfierProperty");
    	SatisfierProperty element = ZDLFactoryRegistry.INSTANCE
    			.create((org.eclipse.emf.ecore.EObject) newConcept,
    ...
    public java.util.List<String> getResourceType(){
            final Object rawValue =
                com.zeligsoft.base.zdl.util.ZDLUtil.getValue(eObject(), "CCM::CCM_Target::RequirementSatisfier", "resourceType");
