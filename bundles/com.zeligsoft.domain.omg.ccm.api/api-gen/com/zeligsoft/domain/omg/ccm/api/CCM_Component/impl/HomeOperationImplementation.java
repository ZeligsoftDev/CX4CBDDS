...
public class HomeOperationImplementation extends
		CORBANamedElementImplementation implements HomeOperation {
	...
	public Home getOwner() {
		if (_owner == null) {
			final Object rawValue = com.zeligsoft.base.zdl.util.ZDLUtil
					.getValue(eObject(), "CCM::CCM_Component::HomeOperation",
							"owner");
	...
	public void setOwner(Home val) {
		ZDLUtil.setValue(element, "CCM::CCM_Component::HomeOperation", "owner",
				val.eObject());
	}
