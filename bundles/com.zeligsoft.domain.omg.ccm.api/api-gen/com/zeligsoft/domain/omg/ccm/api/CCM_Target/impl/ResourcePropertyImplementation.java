...
public class ResourcePropertyImplementation
    extends TypedElementImplementation implements ResourceProperty{
    ...
    public Resource getTypeOverride(){
        if(_type == null) {
            final Object rawValue = 
                com.zeligsoft.base.zdl.util.ZDLUtil.getValue(eObject(), "CCM::CCM_Target::ResourceProperty", "type");
