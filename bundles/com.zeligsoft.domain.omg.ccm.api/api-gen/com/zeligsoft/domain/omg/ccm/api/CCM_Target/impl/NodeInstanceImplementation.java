...
public class NodeInstanceImplementation extends NamedElementImplementation
	...
	public String getLabel() {
		final Object rawValue = com.zeligsoft.base.zdl.util.ZDLUtil.getValue(
				eObject(), "CCM::CCM_Target::NodeInstance", "label");
	...
	public Node getTypeOverride() {
		if (_type == null) {
			final Object rawValue = com.zeligsoft.base.zdl.util.ZDLUtil
					.getValue(eObject(), "CCM::CCM_Target::NodeInstance",
							"type");
			if (rawValue instanceof org.eclipse.emf.ecore.EObject) {
				_type = ZDLFactoryRegistry.INSTANCE.create(
						(org.eclipse.emf.ecore.EObject) rawValue, Node.class);
			}
		}
		return _type;
	}
	...
	public void setTypeOverride(Node val) {
		ZDLUtil.setValue(element, "CCM::CCM_Target::NodeInstance", "type",
				val.eObject());
	}
