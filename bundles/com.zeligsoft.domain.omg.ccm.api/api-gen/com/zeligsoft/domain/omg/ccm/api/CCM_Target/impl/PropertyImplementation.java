...
public class PropertyImplementation extends NamedElementImplementation
		implements Property {
	...
	public CORBAType getTypeOverride() {
		if (_type == null) {
			final Object rawValue = com.zeligsoft.base.zdl.util.ZDLUtil
					.getValue(eObject(), "CCM::CCM_Target::Property", "type");
	...
	public void setTypeOverride(CORBAType val) {
		ZDLUtil.setValue(element, "CCM::CCM_Target::Property", "type",
				val.eObject());
	}
	...
	public String getValue() {
		final Object rawValue = com.zeligsoft.base.zdl.util.ZDLUtil.getValue(
				eObject(), "CCM::CCM_Target::Property", "value");
