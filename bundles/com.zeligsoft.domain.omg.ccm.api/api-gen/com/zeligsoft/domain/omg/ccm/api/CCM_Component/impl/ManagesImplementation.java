...
public class ManagesImplementation extends CORBANamedElementImplementation
		implements Manages {
	...
	public ManagesEnd getComponent() {
		if (_component == null) {
			final Object rawValue = com.zeligsoft.base.zdl.util.ZDLUtil
					.getValue(eObject(), "CCM::CCM_Component::Manages",
							"component");
	...
	public void setComponent(ManagesEnd val) {
		ZDLUtil.setValue(element, "CCM::CCM_Component::Manages", "component",
				val.eObject());
	}

	@Override
	public <T extends ManagesEnd> T createComponent(Class<T> typeToCreate,
			String concept) {
		org.eclipse.emf.ecore.EObject newConcept = ZDLUtil.createZDLConcept(
				element, "CCM::CCM_Component::Manages", "component", concept);
	...
	public ManagesEnd getHome() {
		if (_home == null) {
			final Object rawValue = com.zeligsoft.base.zdl.util.ZDLUtil
					.getValue(eObject(), "CCM::CCM_Component::Manages", "home");
			if (rawValue instanceof org.eclipse.emf.ecore.EObject) {
	...
	public void setHome(ManagesEnd val) {
		ZDLUtil.setValue(element, "CCM::CCM_Component::Manages", "home",
				val.eObject());
	}

	@Override
	public <T extends ManagesEnd> T createHome(Class<T> typeToCreate,
			String concept) {
		org.eclipse.emf.ecore.EObject newConcept = ZDLUtil.createZDLConcept(
				element, "CCM::CCM_Component::Manages", "home", concept);
		T element = ZDLFactoryRegistry.INSTANCE.create(
				newConcept, typeToCreate);
		return element;
	}
