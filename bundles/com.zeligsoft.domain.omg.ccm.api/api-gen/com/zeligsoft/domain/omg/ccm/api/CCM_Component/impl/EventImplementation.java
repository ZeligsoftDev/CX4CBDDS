...
public class EventImplementation extends InterfaceImplementation implements
		Event {
	...
	public Boolean getIsCustom() {
		final Object rawValue = com.zeligsoft.base.zdl.util.ZDLUtil.getValue(
				eObject(), "CCM::CCM_Component::Event", "isCustom");
	...
	public java.util.List<StateMember> getMember() {
		if (_member == null) {
			final Object rawValue = com.zeligsoft.base.zdl.util.ZDLUtil
					.getValue(eObject(), "CCM::CCM_Component::Event", "member");
			_member = new java.util.ArrayList<StateMember>();
			@SuppressWarnings("unchecked")
			final java.util.List<Object> rawList = (java.util.List<Object>) rawValue;
			for (Object next : rawList) {
				if (next instanceof org.eclipse.emf.ecore.EObject) {
					StateMember nextWrapper = ZDLFactoryRegistry.INSTANCE
	...
	public void addMember(StateMember val) {
		...
		final Object rawValue = ZDLUtil.getValue(element,
				"CCM::CCM_Component::Event", "member");
		@SuppressWarnings("unchecked")
		final java.util.List<Object> rawList = (java.util.List<Object>) rawValue;
	...
	public java.util.List<CORBAAttribute> getOwnedAttribute() {
		if (_ownedAttribute == null) {
			final Object rawValue = com.zeligsoft.base.zdl.util.ZDLUtil
					.getValue(eObject(), "CCM::CCM_Component::Event",
							"ownedAttribute");
	...
	public void addOwnedAttribute(CORBAAttribute val) {
		...
		final Object rawValue = ZDLUtil.getValue(element,
				"CCM::CCM_Component::Event", "ownedAttribute");
		@SuppressWarnings("unchecked")
		final java.util.List<Object> rawList = (java.util.List<Object>) rawValue;
		rawList.add(val.eObject());
		if (_ownedAttribute != null) {
	...
	public Boolean getIsAbstract() {
		final Object rawValue = com.zeligsoft.base.zdl.util.ZDLUtil.getValue(
				eObject(), "CCM::CCM_Component::Event", "isAbstract");
		return (Boolean) rawValue;
	}

	@Override
	public void setIsAbstract(Boolean val) {
		ZDLUtil.setValue(element, "CCM::CCM_Component::Event", "isAbstract",
				val);
	}
	...
	public Boolean getIsTruncatable() {
		final Object rawValue = com.zeligsoft.base.zdl.util.ZDLUtil.getValue(
				eObject(), "CCM::CCM_Component::Event", "isTruncatable");
		return (Boolean) rawValue;
	}

	@Override
	public void setIsTruncatable(Boolean val) {
		ZDLUtil.setValue(element, "CCM::CCM_Component::Event", "isTruncatable",
				val);
	}
