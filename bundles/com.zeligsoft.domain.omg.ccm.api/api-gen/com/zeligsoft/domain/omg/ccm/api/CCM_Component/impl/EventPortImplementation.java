...
public class EventPortImplementation extends PortImplementation implements
		EventPort {
	...
	public java.util.List<Event> getPublishesEvent() {
		if (_publishesEvent == null) {
			final Object rawValue = com.zeligsoft.base.zdl.util.ZDLUtil
					.getValue(eObject(), "CCM::CCM_Component::EventPort",
							"publishesEvent");
			...
			for (Object next : rawList) {
				if (next instanceof org.eclipse.emf.ecore.EObject) {
					Event nextWrapper = ZDLFactoryRegistry.INSTANCE.create(
							(org.eclipse.emf.ecore.EObject) next, Event.class);
	...
	public void setType(Type val) {
		ZDLUtil.setValue(element, "CCM::CCM_Component::EventPort", "type",
				val.eObject());
	}
