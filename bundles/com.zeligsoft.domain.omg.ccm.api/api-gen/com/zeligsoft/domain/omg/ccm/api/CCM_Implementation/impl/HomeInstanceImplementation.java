...
public class HomeInstanceImplementation
    extends PartImplementation implements HomeInstance{
    ...
    public Home getDefinitionOverride(){
        if(_definition == null) {
            final Object rawValue = 
                com.zeligsoft.base.zdl.util.ZDLUtil.getValue(eObject(), "CCM::CCM_Implementation::HomeInstance", "definition");
