...
public class ManagesImplImplementation
    extends ZObjectImpl implements ManagesImpl{
    ...
    public ManagesImplEnd getHome(){
        if(_home == null) {
            final Object rawValue = 
                com.zeligsoft.base.zdl.util.ZDLUtil.getValue(eObject(), "CCM::CCM_Implementation::ManagesImpl", "home");
            if(rawValue instanceof org.eclipse.emf.ecore.EObject) {
              _home = ZDLFactoryRegistry.INSTANCE.create((org.eclipse.emf.ecore.EObject)rawValue, ManagesImplEnd.class);
            }
        }
        return _home;
    }
    ...
    public <T extends ManagesImplEnd> T createHome(Class<T> typeToCreate, String concept)
    {
    	org.eclipse.emf.ecore.EObject newConcept = 
    		ZDLUtil.createZDLConcept(element, "CCM::CCM_Implementation::ManagesImpl", "home", concept);
    ...
    public ManagesImplEnd getComponent(){
        if(_component == null) {
            final Object rawValue = 
                com.zeligsoft.base.zdl.util.ZDLUtil.getValue(eObject(), "CCM::CCM_Implementation::ManagesImpl", "component");
            if(rawValue instanceof org.eclipse.emf.ecore.EObject) {
              _component = ZDLFactoryRegistry.INSTANCE.create((org.eclipse.emf.ecore.EObject)rawValue, ManagesImplEnd.class);
            }
        }
        return _component;
    }
    ...
    {
    	org.eclipse.emf.ecore.EObject newConcept = 
    		ZDLUtil.createZDLConcept(element, "CCM::CCM_Implementation::ManagesImpl", "component", concept);
    	T element = ZDLFactoryRegistry.INSTANCE
    			.create((org.eclipse.emf.ecore.EObject) newConcept,
    					typeToCreate);
    	return element;
