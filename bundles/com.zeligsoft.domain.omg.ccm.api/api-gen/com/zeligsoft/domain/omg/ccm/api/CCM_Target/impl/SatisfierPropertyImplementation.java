...
public class SatisfierPropertyImplementation extends NamedElementImplementation implements SatisfierProperty {
	...
	public SatisfierPropertyKind getKind() {
		final Object rawValue = com.zeligsoft.base.zdl.util.ZDLUtil.getValue(eObject(),
				"CCM::CCM_Target::SatisfierProperty", "kind");
	...
	public Boolean getDynamic() {
		final Object rawValue = com.zeligsoft.base.zdl.util.ZDLUtil.getValue(eObject(),
				"CCM::CCM_Target::SatisfierProperty", "dynamic");
	...
	public CXType getTypeOverride() {
		if (_type == null) {
			final Object rawValue = com.zeligsoft.base.zdl.util.ZDLUtil.getValue(eObject(),
					"CCM::CCM_Target::SatisfierProperty", "type");
			if (rawValue instanceof org.eclipse.emf.ecore.EObject) {
	...
	public String getValue() {
		final Object rawValue = com.zeligsoft.base.zdl.util.ZDLUtil.getValue(eObject(),
				"CCM::CCM_Target::SatisfierProperty", "value");
