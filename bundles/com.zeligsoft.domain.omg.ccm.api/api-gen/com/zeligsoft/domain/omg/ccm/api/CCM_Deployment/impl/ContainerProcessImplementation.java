...
public class ContainerProcessImplementation
    extends NamedElementImplementation implements ContainerProcess{
    ...
    public java.util.List<Property> getProperty(){
        if(_property == null) {
            final Object rawValue = 
                com.zeligsoft.base.zdl.util.ZDLUtil.getValue(eObject(), "CCM::CCM_Deployment::ContainerProcess", "property");
