...
public interface Manages extends CORBANamedElement {
	ManagesEnd getHome();
	...
	<T extends ManagesEnd> T createComponent(Class<T> typeToCreate,
			String concept);
	 ...
	 * instance of Manages
	 */
	static final TypeSelectPredicate<Manages> type = new TypeSelectPredicate<Manages>(
			"CCM::CCM_Component::Manages", //$NON-NLS-1$
			Manages.class);
}
