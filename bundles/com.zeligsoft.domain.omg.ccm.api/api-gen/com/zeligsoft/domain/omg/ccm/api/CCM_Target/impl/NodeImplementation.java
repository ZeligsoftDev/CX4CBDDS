...
public class NodeImplementation
    extends NamedElementImplementation implements Node{
    protected java.util.List<ResourceProperty> _resource;
    public NodeImplementation(org.eclipse.emf.ecore.EObject element) {
        super(element);
    }
    ...
    public java.util.List<ResourceProperty> getResource(){
        if(_resource == null) {
            final Object rawValue = 
                com.zeligsoft.base.zdl.util.ZDLUtil.getValue(eObject(), "CCM::CCM_Target::Node", "resource");
    ...
    public void addResource(ResourceProperty val){
    	...
    	final Object rawValue = ZDLUtil.getValue(element, "CCM::CCM_Target::Node", "resource");
    	@SuppressWarnings("unchecked")
    	final java.util.List<Object> rawList = (java.util.List<Object>) rawValue;
    ...
    public <T extends ResourceProperty> T addResource(Class<T> typeToCreate, String concept){
    	...
    	org.eclipse.emf.ecore.EObject newConcept = 
    		ZDLUtil.createZDLConcept(element, "CCM::CCM_Target::Node", "resource", concept);
    ...
    public ResourceProperty addResource(){
    	...
    	getResource();
    	org.eclipse.emf.ecore.EObject newConcept = 
    		ZDLUtil.createZDLConcept(element, "CCM::CCM_Target::Node", "resource", "CCM::CCM_Target::ResourceProperty");
