...
public class CCMFactoryImpl extends AbstractBaseZDLFactory {
	protected java.util.Map<String, Class<?>> registry = Maps.newHashMap();

	public CCMFactoryImpl() {
		...
		registry.put("CCM::CCM_Artifacts::IDL3File",
				com.zeligsoft.domain.omg.ccm.api.CCM_Artifacts.impl.IDL3FileImplementation.class);
		registry.put("CCM::CCM_Artifacts::IDL3FileImport",
				com.zeligsoft.domain.omg.ccm.api.CCM_Artifacts.impl.IDL3FileImportImplementation.class);
