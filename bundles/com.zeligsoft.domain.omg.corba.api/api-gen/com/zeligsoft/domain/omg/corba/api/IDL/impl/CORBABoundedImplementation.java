...
public abstract class CORBABoundedImplementation extends
		CORBANamedElementImplementation implements CORBABounded {
	...
	public CORBABound getBounds() {
		if (_bounds == null) {
			final Object rawValue = com.zeligsoft.base.zdl.util.ZDLUtil
					.getValue(eObject(), "CORBADomain::IDL::CORBABounded",
							"bounds");
	...
	public void setBounds(CORBABound val) {
		ZDLUtil.setValue(element, "CORBADomain::IDL::CORBABounded", "bounds",
				val.eObject());
	}
	...
	public <T extends CORBABound> T createBounds(Class<T> typeToCreate,
		...
		org.eclipse.emf.ecore.EObject newConcept = ZDLUtil.createZDLConcept(
				element, "CORBADomain::IDL::CORBABounded", "bounds", concept);
	...
	public CORBABound createBounds() {
		org.eclipse.emf.ecore.EObject newConcept = ZDLUtil.createZDLConcept(
				element, "CORBADomain::IDL::CORBABounded", "bounds",
	...
	public String getBound() {
		final Object rawValue = com.zeligsoft.base.zdl.util.ZDLUtil.getValue(
				eObject(), "CORBADomain::IDL::CORBABounded", "bound");
		return (String) rawValue;
	}

	@Override
	public void setBound(String val) {
		ZDLUtil.setValue(element, "CORBADomain::IDL::CORBABounded", "bound",
				val);
	}
