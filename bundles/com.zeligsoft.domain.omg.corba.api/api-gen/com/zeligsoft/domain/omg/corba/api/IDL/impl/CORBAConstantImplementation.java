...
public class CORBAConstantImplementation
    extends CORBANamedElementImplementation implements CORBAConstant{
    ...
    public String getDefault(){
            final Object rawValue =
                com.zeligsoft.base.zdl.util.ZDLUtil.getValue(eObject(), "CORBADomain::IDL::CORBAConstant", "default");
            return (String) rawValue;
    }
    public void setDefault(String val)
    {
    				ZDLUtil.setValue(element, "CORBADomain::IDL::CORBAConstant", "default", val);
    			}
