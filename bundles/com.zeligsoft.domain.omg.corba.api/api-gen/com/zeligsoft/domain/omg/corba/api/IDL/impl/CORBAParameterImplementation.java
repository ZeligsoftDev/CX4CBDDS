...
public class CORBAParameterImplementation extends CORBATypedImplementation
		implements CORBAParameter {
	...
	public org.eclipse.uml2.uml.ParameterDirectionKind getDirection() {
		final Object rawValue = com.zeligsoft.base.zdl.util.ZDLUtil.getValue(
				eObject(), "CORBADomain::IDL::CORBAParameter", "direction");
	...
	public void setDirection(org.eclipse.uml2.uml.ParameterDirectionKind val) {
		ZDLUtil.setValue(element, "CORBADomain::IDL::CORBAParameter",
				"direction", val);
	}
