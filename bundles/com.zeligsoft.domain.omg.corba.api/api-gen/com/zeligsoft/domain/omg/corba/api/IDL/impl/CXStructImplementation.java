...
public class CXStructImplementation extends CXConstructedImplementation implements CXStruct {
	protected java.util.List<CXField> _members;

	public CXStructImplementation(org.eclipse.emf.ecore.EObject element) {
		super(element);
	}
	...
	public java.util.List<CXField> getMembers() {
		if (_members == null) {
			final Object rawValue = com.zeligsoft.base.zdl.util.ZDLUtil.getValue(eObject(), "CXDomain::IDL::CXStruct",
					"members");
	...
	public void addMembers(CXField val) {
		...
		final Object rawValue = ZDLUtil.getValue(element, "CXDomain::IDL::CXStruct", "members");
		@SuppressWarnings("unchecked")
		final java.util.List<Object> rawList = (java.util.List<Object>) rawValue;
	...
	public <T extends CXField> T addMembers(Class<T> typeToCreate, String concept) {
		// make sure the members list is created
		getMembers();
		org.eclipse.emf.ecore.EObject newConcept = ZDLUtil.createZDLConcept(element, "CXDomain::IDL::CXStruct",
				"members", concept);
