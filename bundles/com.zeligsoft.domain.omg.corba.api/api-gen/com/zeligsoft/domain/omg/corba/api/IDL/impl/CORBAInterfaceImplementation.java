...
public class CORBAInterfaceImplementation
    extends InterfaceImplementation implements CORBAInterface{
    ...
    public Boolean getIsAbstract(){
            final Object rawValue =
                com.zeligsoft.base.zdl.util.ZDLUtil.getValue(eObject(), "CORBADomain::IDL::CORBAInterface", "isAbstract");
            return (Boolean) rawValue;
    }
    public void setIsAbstract(Boolean val)
    {
    				ZDLUtil.setValue(element, "CORBADomain::IDL::CORBAInterface", "isAbstract", val);
    			}
    ...
    public java.util.List<CORBAInterface> getGenerals(){
        if(_generals == null) {
            final Object rawValue = 
                com.zeligsoft.base.zdl.util.ZDLUtil.getValue(eObject(), "CORBADomain::IDL::CORBAInterface", "generals");
            _generals = new java.util.ArrayList<CORBAInterface>();
            @SuppressWarnings("unchecked")
            final java.util.List<Object> rawList = (java.util.List<Object>) rawValue;
            for(Object next : rawList) {
                if(next instanceof org.eclipse.emf.ecore.EObject) {
                    CORBAInterface nextWrapper = 
                         ZDLFactoryRegistry.INSTANCE.create((org.eclipse.emf.ecore.EObject) next, CORBAInterface.class);
    ...
    public void addGenerals(CORBAInterface val)
    {
    				...
    				final Object rawValue = ZDLUtil.getValue(element, "CORBADomain::IDL::CORBAInterface", "generals");
    				@SuppressWarnings("unchecked")
    				final java.util.List<Object> rawList = (java.util.List<Object>) rawValue;
    				rawList.add(val.eObject());
    				if(_generals != null) {
    ...
    public Boolean getIsAsynchronous(){
            final Object rawValue =
                com.zeligsoft.base.zdl.util.ZDLUtil.getValue(eObject(), "CORBADomain::IDL::CORBAInterface", "isAsynchronous");
            return (Boolean) rawValue;
    }
    public void setIsAsynchronous(Boolean val)
    {
    				ZDLUtil.setValue(element, "CORBADomain::IDL::CORBAInterface", "isAsynchronous", val);
    			}
    public Boolean getIsLocal(){
            final Object rawValue =
                com.zeligsoft.base.zdl.util.ZDLUtil.getValue(eObject(), "CORBADomain::IDL::CORBAInterface", "isLocal");
            return (Boolean) rawValue;
    }
    public void setIsLocal(Boolean val)
    {
    				ZDLUtil.setValue(element, "CORBADomain::IDL::CORBAInterface", "isLocal", val);
    			}
