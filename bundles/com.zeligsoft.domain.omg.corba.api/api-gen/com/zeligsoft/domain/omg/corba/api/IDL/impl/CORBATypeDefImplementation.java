...
public class CORBATypeDefImplementation extends CORBAWrapperImplementation
		implements CORBATypeDef {
	...
	public CORBAType getType() {
		if (_type == null) {
			final Object rawValue = com.zeligsoft.base.zdl.util.ZDLUtil
					.getValue(eObject(), "CORBADomain::IDL::CORBATypeDef",
							"type");
	...
	public void setType(CORBAType val) {
		ZDLUtil.setValue(element, "CORBADomain::IDL::CORBATypeDef", "type",
				val.eObject());
	}
