...
public interface CORBAOperation extends CORBANamedElement, CORBATyped, Operation, WorkerFunctionIdentifiable {
Boolean getIsOneWay();
...
<T extends CORBAParameter> T addOwnedParameter(Class<T> typeToCreate, String concept);
 ...
 */
static final TypeSelectPredicate<CORBAOperation> type = 
    new TypeSelectPredicate<CORBAOperation>(
