...
public class CORBAPrimitiveImplementation extends
		CORBANamedElementImplementation implements CORBAPrimitive {
	...
	public CORBAPrimitiveKind getType() {
		final Object rawValue = com.zeligsoft.base.zdl.util.ZDLUtil.getValue(
				eObject(), "CORBADomain::IDL::CORBAPrimitive", "type");

		if (_type == null) {
			if (rawValue instanceof org.eclipse.emf.ecore.EObject) {
				_type = CORBAPrimitiveKind
	...
	public void setType(CORBAPrimitiveKind val) {
		ZDLUtil.setValue(element, "CORBADomain::IDL::CORBAPrimitive", "type",
				val.eObject(element));
	}
