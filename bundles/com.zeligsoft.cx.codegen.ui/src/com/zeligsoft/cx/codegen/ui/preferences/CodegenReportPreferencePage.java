...
public class CodegenReportPreferencePage extends PreferencePage implements IWorkbenchPreferencePage {
	...
	static {
		filesSetCheckboxLabel.put(FilesSet.ADDED, Messages.CXCodegenReportPreferencePage_FilesAddedCheckbox);
		filesSetCheckboxLabel.put(FilesSet.CHANGED, Messages.CXCodegenReportPreferencePage_FilesChangedCheckbox);
		filesSetCheckboxLabel.put(FilesSet.REMOVED, Messages.CXCodegenReportPreferencePage_FilesRemovedCheckbox);
		filesSetCheckboxLabel.put(FilesSet.UNCHANGED, Messages.CXCodegenReportPreferencePage_FilesUnchangedCheckbox);
		filesSetCheckboxLabel.put(FilesSet.BEFORE, Messages.CXCodegenReportPreferencePage_FilesBeforeCheckbox);
		filesSetCheckboxLabel.put(FilesSet.AFTER, Messages.CXCodegenReportPreferencePage_FilesAfterCheckbox);
		checkBoxPreferenceKey.put(FilesSet.ADDED, CXCodegenUIPreferencesConstants.FILE_COLLECTOR_FILES_ADDED);
		checkBoxPreferenceKey.put(FilesSet.CHANGED, CXCodegenUIPreferencesConstants.FILE_COLLECTOR_FILES_CHANGED);
		checkBoxPreferenceKey.put(FilesSet.REMOVED, CXCodegenUIPreferencesConstants.FILE_COLLECTOR_FILES_REMOVED);
		checkBoxPreferenceKey.put(FilesSet.UNCHANGED, CXCodegenUIPreferencesConstants.FILE_COLLECTOR_FILES_UNCHANGED);
		checkBoxPreferenceKey.put(FilesSet.BEFORE, CXCodegenUIPreferencesConstants.FILE_COLLECTOR_FILES_BEFORE);
		checkBoxPreferenceKey.put(FilesSet.AFTER, CXCodegenUIPreferencesConstants.FILE_COLLECTOR_FILES_AFTER);
		checkBoxPreferenceDefault.put(FilesSet.ADDED, CXCodegenUIPreferencesConstants.FILE_COLLECTOR_FILES_ADDED_DEFAULT);
		checkBoxPreferenceDefault.put(FilesSet.CHANGED, CXCodegenUIPreferencesConstants.FILE_COLLECTOR_FILES_CHANGED_DEFAULT);
		checkBoxPreferenceDefault.put(FilesSet.REMOVED, CXCodegenUIPreferencesConstants.FILE_COLLECTOR_FILES_REMOVED_DEFAULT);
		checkBoxPreferenceDefault.put(FilesSet.UNCHANGED, CXCodegenUIPreferencesConstants.FILE_COLLECTOR_FILES_UNCHANGED_DEFAULT);
		checkBoxPreferenceDefault.put(FilesSet.BEFORE, CXCodegenUIPreferencesConstants.FILE_COLLECTOR_FILES_BEFORE_DEFAULT);
		checkBoxPreferenceDefault.put(FilesSet.AFTER, CXCodegenUIPreferencesConstants.FILE_COLLECTOR_FILES_AFTER_DEFAULT);
	}
	...
	private void createFileCollectorGroup(Composite panel) {
		...
		group.setText(Messages.CXCodegenReportPreferencePage_FileCollectorGroup);
	...
	private void createFileCollectorQuestion(Composite group) {
		...
		label.setText(Messages.CXCodegenReportPreferencePage_FileCollectorQuestion);
	}
	...
	private void createFilesSetCheckbox(Composite group, FilesSet filesSet) {
		...
		includeFilesSetCheckbox.get(filesSet).setSelection(PREFERENCE_SERVICE.getBoolean(CodeGenUIPlugin.PLUGIN_ID,
	...
	public boolean performCancel() {
		CodeGenUIPlugin.getDefault().info(Messages.CXCodegenReportPreferencePage_Cancelling);
		for (FilesSet filesSet : FilesSet.values()) {
	...
	public boolean performOk() {
		performApply();
		try {
			CodeGenUIPlugin.getDefault().info(Messages.CXCodegenReportPreferencePage_Saving);
			WORKSPACE_PREFERENCES.flush();
		} catch (BackingStoreException e) {
			CodeGenUIPlugin.getDefault().error(Messages.CXCodegenReportPreferencePage_ErrorSaving, e);
			e.printStackTrace();
		}
	...
	public void init(IWorkbench workbench) {
		for (FilesSet filesSet : FilesSet.values()) {
			currentValue.put(filesSet, PREFERENCE_SERVICE.getBoolean(CodeGenUIPlugin.PLUGIN_ID,
					checkBoxPreferenceKey.get(filesSet), checkBoxPreferenceDefault.get(filesSet), null));
		}
	}
}
