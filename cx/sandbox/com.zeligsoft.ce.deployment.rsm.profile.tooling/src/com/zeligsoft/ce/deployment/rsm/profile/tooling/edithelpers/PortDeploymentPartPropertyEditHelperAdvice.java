 ...
 * @generated
 */
public class PortDeploymentPartPropertyEditHelperAdvice extends
    ...
    protected String getLocalizedName(EObject eObject) {
        ...
        Stereotype stereotype = element.getAppliedStereotype(ZDLDeploymentElementTypes._PORTDEPLOYMENTPART__PROPERTY.getStereotypeName());
