 ...
 * @generated
 */
public class AllocationAssociationEditHelperAdvice extends
    ...
    protected String getLocalizedName(EObject eObject) {
        ...
        Stereotype stereotype = element.getAppliedStereotype(ZDLDeploymentElementTypes._ALLOCATION__ASSOCIATION.getStereotypeName());
