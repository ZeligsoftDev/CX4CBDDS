 ...
 * @generated
 */
public class ConnectorDeploymentPartPropertyEditHelperAdvice extends
    ...
    protected String getLocalizedName(EObject eObject) {
        ...
        Stereotype stereotype = element.getAppliedStereotype(ZDLDeploymentElementTypes._CONNECTORDEPLOYMENTPART__PROPERTY.getStereotypeName());
