 ...
 * @generated
 */
public class PartDeploymentPartPropertyEditHelperAdvice extends
    ...
    protected String getLocalizedName(EObject eObject) {
        ...
        Stereotype stereotype = element.getAppliedStereotype(ZDLDeploymentElementTypes._PARTDEPLOYMENTPART__PROPERTY.getStereotypeName());
