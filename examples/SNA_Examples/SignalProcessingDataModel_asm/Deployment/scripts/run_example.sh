...
function quit 
{
   ...
   $SNA_ROOT/tools/scripts/sna_shutdown_components.py \
                                    ../descriptors/SPDM_Example.cdp -i EM.$$.ior
...
export PSAT_CONFIG_PATH=$SNA_CONFIG_PATH
...
export DDS4CCM_LOG_LEVEL=${DDS4CCM_LOG_LEVEL:=2}
...
$SNA_ROOT/tools/scripts/sna_start_nodes.py ../descriptors/SPDM_Example_VM.cdd
...
$SNA_ROOT/tools/scripts/sna_start_components.py \
                                          ../descriptors/SPDM_Example_VM.cdd \
                                          ../descriptors/SPDM_Example.cdp \
                                          -i EM.$$.ior
