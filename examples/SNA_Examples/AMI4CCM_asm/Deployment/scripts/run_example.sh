...
function quit 
{
   ...
   $SNA_ROOT/tools/scripts/sna_shutdown_components.py \
                                     ../descriptors/AMI4CCM_asm.cdp -i EM.$$.ior
...
$SNA_ROOT/tools/scripts/sna_start_nodes.py ../descriptors/AMI4CCM_asm.cdd
...
$SNA_ROOT/tools/scripts/sna_start_components.py \
                                          ../descriptors/AMI4CCM_asm.cdd \
                                          ../descriptors/AMI4CCM_asm.cdp \
                                          -i EM.$$.ior
