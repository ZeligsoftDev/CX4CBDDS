...
function quit 
{
   ...
   $SNA_ROOT/tools/scripts/sna_shutdown_components.py \
                                  ../descriptors/CollocatedPlan.cdp -i EM.$$.ior
...
$SNA_ROOT/tools/scripts/sna_start_nodes.py ../descriptors/CollocatedPlan.cdd
...
$SNA_ROOT/tools/scripts/sna_start_components.py \
                                          ../descriptors/CollocatedPlan.cdd \
                                          ../descriptors/CollocatedPlan.cdp \
                                          -i EM.$$.ior
